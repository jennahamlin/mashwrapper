...
if (!params.input) {
    exit 1, 'Input reads samplesheet not specified!'
}
...
if (params.get_database) {
    ...
    You must specify either:
      --use_database: User provides path to a pre-built mash database.
      --get_database: User provides a text file of organisms to download.
    """)
}
/*
