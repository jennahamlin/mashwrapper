...
grep -v 'Legionella sp\.' temp > downloadedData2.tsv
grep -v 'uncultured Legionella sp.' downloadedData2.tsv > downloadedData3.tsv
grep -v 'Legionella genomosp' downloadedData3.tsv > downloadedData.tsv
rm downloadedData3.tsv
rm downloadedData2.tsv
...
only identified to genus..."
  ...
  rm Legionella_genomosp.*.fna #taxnomoy is inconclusive
else
