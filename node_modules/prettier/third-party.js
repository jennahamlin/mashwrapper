  ...
  "node_modules/yaml/dist/parse-cst.js"(exports2) {
    ...
    var CollectionItem = class extends PlainValue.Node {
      ...
      parse(context, start) {
        ...
        if (
          PlainValue.Node.nextNodeIsIndented(ch, offset - (lineStart + indent), this.type !== PlainValue.Type.SEQ_ITEM)
        ) {
          this.node = parseNode(
            {
              atLineStart,
    ...
    var QuoteDouble = class extends PlainValue.Node {
      ...
      parseCharCode(offset, length, errors) {
        ...
        if (isNaN(code)) {
          errors.push(
            new PlainValue.YAMLSyntaxError(this, `Invalid escape sequence ${src.substr(offset - 2, length + 2)}`)
          );
    ...
    var Collection = class extends Node {
      ...
      toString(ctx, { blockItem, flowChars, isMap, itemIndent }, onComment, onChompKeep) {
        ...
        if (nodes.length === 0) {
          ...
          if (
            hasItemWithNewLine ||
            strings.reduce((sum, str2) => sum + str2.length + 2, 2) > Collection.maxFlowStringSingleLineLength
          ) {
            str = start;
...
${indent}`
    ...
    var isCollectionItem = (node) => {
      ...
      const { type } = node;
      return (
        type === PlainValue.Type.MAP_KEY || type === PlainValue.Type.MAP_VALUE || type === PlainValue.Type.SEQ_ITEM
      );
    };
...
${ctx.indent}${str}`;
    ...
    var Anchors = class {
      static validAnchorNode(node) {
        return (
          node instanceof resolveSeq.Scalar || node instanceof resolveSeq.YAMLSeq || node instanceof resolveSeq.YAMLMap
        );
      }
      constructor(prefix) {
