(function (e) {
  ...
  var Ye = be((yg, ru) => {
    ...
    ru.exports =
      ...
      er(typeof global == "object" && global) ||
      (function () {
        return this;
      })() ||
  ...
  var Iu = be((kg, Pu) => {
    ...
    !ar &&
      Rr &&
      ((lt = Rr.match(/Edge\/(\d+)/)), (!lt || lt[1] >= 74) && ((lt = Rr.match(/Chrome\/(\d+)/)), lt && (ar = +lt[1])));
    Pu.exports = ar;
  });
  var Vr = be((Lg, Lu) => {
    var ku = Iu(),
      ...
      ? tl
        ? function (n, t, s) {
            if (
              ...
              (t = Es(t)),
              Dr(s),
              typeof n == "function" && t === "prototype" && "value" in s && tn in s && !s[tn])
            ) {
              var i = nl(n, t);
              i &&
                i[tn] &&
                ((n[t] = s.value),
                (s = { configurable: en in s ? s[en] : i[en], enumerable: Zr in s ? s[Zr] : i[Zr], writable: !1 }));
            }
            return Qr(n, t, s);
          }
        : Qr
    ...
    ($s.exports = function (e, n, t, s) {
      ...
      if (
        (Rs(t) &&
          ...
          (c = Il(t)),
          c.source || (c.source = kl.join(typeof a == "string" ? a : ""))),
        e === Tl)
      ) {
        r ? (e[n] = t) : Nl(n, t);
        return;
    ...
    ga.exports = function (e, n) {
      ...
      if ((s ? (u = Dn) : i ? (u = Dn[t] || hp(t, {})) : (u = (Dn[t] || {}).prototype), u))
        for (a in n) {
          if (
            ((l = n[a]),
            e.noTargetGet ? ((C = dp(u, a)), (c = C && C.value)) : (c = u[a]),
  ...
  var La = be((_0, ka) => {
    ...
    ka.exports = function (e) {
      ...
      return (
        Pa(e) &&
          ((n = e.constructor),
          Xp(n) && (n === Ia || Pa(n.prototype)) ? (n = void 0) : Kp(n) && ((n = n[Qp]), n === null && (n = void 0))),
        n === void 0 ? Ia : n
      );
    };
  });
      ...
      { target: "Array", proto: !0 },
      {
        flatMap: function (n) {
          var t = nf(this),
            ...
            i;
          return (
            rf(n), (i = sf(t, 0)), (i.length = tf(i, t, t, s, 0, 1, n, arguments.length > 1 ? arguments[1] : void 0)), i
          );
        },
      }
    );
    ...
    var Pn = Object.defineProperty,
        ...
        "node_modules/diff/lib/diff/base.js"(e) {
          ...
          n.prototype = {
            diff: function (r, u) {
              ...
              if (h[0].newPos + 1 >= m && N + 1 >= g) return C([{ value: this.join(u), count: u.length }]);
              function T() {
                for (var b = -1 * p; b <= p; b += 2) {
                  ...
                  if (
                    (!E || (D && B.newPos < w.newPos)
                      ...
                      : ((v = B), v.newPos++, l.pushComponent(v.components, !0, void 0)),
            ...
            pushComponent: function (r, u, a) {
              ...
              c && c.added === u && c.removed === a
                ? (r[r.length - 1] = { count: c.count + 1, added: u, removed: a })
                : r.push({ count: 1, added: u, removed: a });
            },
            extractCommon: function (r, u, a, c) {
              for (
                var l = u.length, C = a.length, m = r.newPos, g = m - c, p = 0;
                m + 1 < l && g + 1 < C && this.equals(u[m + 1], a[g + 1]);
      ...
      rD = Z({
        "node_modules/diff/lib/diff/array.js"(e) {
          "use strict";
          ae(), Object.defineProperty(e, "__esModule", { value: !0 }), (e.diffArrays = i), (e.arrayDiff = void 0);
          var n = t(tD());
          function t(r) {
...
`
      ...
      nD = Z({
        "vendors/string-width.js"(e, n) {
          ...
          var t = Object.create,
            ...
            m = (v, B, w) => (
              (w = v != null ? t(u(v)) : {}),
              C(B || !v || !v.__esModule ? s(w, "default", { value: v, enumerable: !0 }) : w, v)
            ),
      ...
      jn = Z({
        "src/document/doc-utils.js"(e, n) {
          ...
          function I(o) {
            return l(o, (x) =>
              Array.isArray(x) ? w(x) : x.parts ? Object.assign(Object.assign({}, x), {}, { parts: w(x.parts) }) : x
            );
          }
          function E(o) {
            return l(o, (x) =>
          ...
          function h(v, B, w) {
            return B === Number.NEGATIVE_INFINITY
              ...
              ? B.type === "root"
                ...
                : N(v, { type: typeof B == "string" ? "stringAlign" : "numberAlign", n: B }, w)
              : v;
          }
          function N(v, B, w) {
            let I = B.type === "dedent" ? v.queue.slice(0, -1) : [...v.queue, B],
              E = "",
              D = 0,
              d = 0,
              y = 0;
...
`
                ...
                switch (k.type) {
                  ...
                  case "line-suffix":
                    ...
                    break;
                  case "line-suffix-boundary":
                    o.length > 0 && D.push([F, S, { type: "line", hard: !0 }]);
                    break;
                  case "line":
                    switch (S) {
                      case g:
                      ...
                      case m:
                        ...
                        k.literal
                          ? F.root
                            ? (d.push(I, F.root.value), (E = F.root.length))
                            : (d.push(I), (E = 0))
                          : ((E -= T(d)), d.push(I + F.value), (E = F.length));
                        break;
                    }
                    break;
                  case "label":
          ...
          function i(u) {
            ...
            return u.type === "if-break"
              ? Object.assign(
                  Object.assign({}, u),
                  {},
                  { breakContents: i(u.breakContents), flatContents: i(u.flatContents) }
                )
              : u.type === "group"
              ? Object.assign(
                  Object.assign({}, u),
                  {},
                  { contents: i(u.contents), expandedStates: u.expandedStates && u.expandedStates.map(i) }
                )
              : u.type === "fill"
              ? { type: "fill", parts: u.parts.map(i) }
              : u.contents
              ? Object.assign(Object.assign({}, u), {}, { contents: i(u.contents) })
              : u;
          }
          function r(u) {
            ...
            function l(m, g, p) {
              ...
              if (m.type === "break-parent")
                return Array.isArray(p) && p[g - 1] && p[g - 1].type === "line" && p[g - 1].hard
                  ? void 0
                  : "breakParent";
              ...
              if (m.type === "if-break")
                return (
                  ...
                  (m.groupId ? (m.flatContents ? "" : ', ""') + ", { groupId: ".concat(C(m.groupId), " }") : "") +
                  ")"
                );
              ...
              if (m.type === "group") {
                ...
                return m.expandedStates
                  ? "conditionalGroup([".concat(m.expandedStates.map((N) => l(N)).join(","), "]").concat(h, ")")
      ...
      hi = Z({
        "node_modules/semver/internal/debug.js"(e, n) {
          ae();
          var t =
            typeof xt == "object" && xt.env && xt.env.NODE_DEBUG && /\bsemver\b/i.test(xt.env.NODE_DEBUG)
              ? function () {
      ...
      iD = Z({
        "node_modules/semver/internal/re.js"(e, n) {
          ...
          c("NUMERICIDENTIFIER", "0|[1-9]\\d*"),
            ...
            c("PRERELEASEIDENTIFIER", "(?:".concat(r[u.NUMERICIDENTIFIER], "|").concat(r[u.NONNUMERICIDENTIFIER], ")")),
            c(
            ...
            c(
              "PRERELEASELOOSE",
              "(?:-?(".concat(r[u.PRERELEASEIDENTIFIERLOOSE], "(?:\\.").concat(r[u.PRERELEASEIDENTIFIERLOOSE], ")*))")
            ),
            c("BUILDIDENTIFIER", "[0-9A-Za-z-]+"),
            c("BUILD", "(?:\\+(".concat(r[u.BUILDIDENTIFIER], "(?:\\.").concat(r[u.BUILDIDENTIFIER], ")*))")),
            c("FULLPLAIN", "v?".concat(r[u.MAINVERSION]).concat(r[u.PRERELEASE], "?").concat(r[u.BUILD], "?")),
            ...
            c("GTLT", "((?:<|>)?=?)"),
            c("XRANGEIDENTIFIERLOOSE", "".concat(r[u.NUMERICIDENTIFIERLOOSE], "|x|X|\\*")),
            c("XRANGEIDENTIFIER", "".concat(r[u.NUMERICIDENTIFIER], "|x|X|\\*")),
            c(
              "XRANGEPLAIN",
              "[v=\\s]*("
            ...
            c("XRANGE", "^".concat(r[u.GTLT], "\\s*").concat(r[u.XRANGEPLAIN], "$")),
            c("XRANGELOOSE", "^".concat(r[u.GTLT], "\\s*").concat(r[u.XRANGEPLAINLOOSE], "$")),
            c(
              "COERCE",
              "(^|[^\\d])(\\d{1,"
                .concat(t, "})(?:\\.(\\d{1,")
            ...
            c("TILDE", "^".concat(r[u.LONETILDE]).concat(r[u.XRANGEPLAIN], "$")),
            c("TILDELOOSE", "^".concat(r[u.LONETILDE]).concat(r[u.XRANGEPLAINLOOSE], "$")),
            c("LONECARET", "(?:\\^)"),
            c("CARETTRIM", "(\\s*)".concat(r[u.LONECARET], "\\s+"), !0),
            (e.caretTrimReplace = "$1^"),
            c("CARET", "^".concat(r[u.LONECARET]).concat(r[u.XRANGEPLAIN], "$")),
            c("CARETLOOSE", "^".concat(r[u.LONECARET]).concat(r[u.XRANGEPLAINLOOSE], "$")),
            c("COMPARATORLOOSE", "^".concat(r[u.GTLT], "\\s*(").concat(r[u.LOOSEPLAIN], ")$|^$")),
            c("COMPARATOR", "^".concat(r[u.GTLT], "\\s*(").concat(r[u.FULLPLAIN], ")$|^$")),
            c(
              "COMPARATORTRIM",
            ...
            c("HYPHENRANGE", "^\\s*(".concat(r[u.XRANGEPLAIN], ")\\s+-\\s+(").concat(r[u.XRANGEPLAIN], ")\\s*$")),
            c(
              "HYPHENRANGELOOSE",
            ...
            l = class {
              ...
              compareMain(C) {
                return (
                  ...
                  c(this.major, C.major) || c(this.minor, C.minor) || c(this.patch, C.patch)
                );
              }
              comparePre(C) {
      ...
      mD = Z({
        "node_modules/outdent/lib/index.js"(e, n) {
          ...
          var T = N({ trimLeadingNewline: !0, trimTrailingNewline: !0 });
          if (((e.outdent = T), (e.default = T), typeof n < "u"))
            try {
              (n.exports = T), Object.defineProperty(T, "__esModule", { value: !0 }), (T.default = T), (T.outdent = T);
            } catch {}
        },
      }),
      dD = Z({
                  ...
                  (A = Object.assign({}, A)),
                    Array.isArray(A.default) &&
                      (A.default =
                        A.default.length === 1
                          ? A.default[0].value
                          : A.default.filter(h).sort((v, B) => t.compare(B.since, v.since))[0].value),
                    Array.isArray(A.choices) &&
                      ((A.choices = A.choices.filter((v) => h(v) && N(v))), A.name === "parser" && a(A, p, c));
      ...
      Ge = Z({
        "src/common/util.js"(e, n) {
          ...
          var { default: t } = aD(),
            ...
            r = Rn(),
            u = yi(),
            { skipWhitespace: a, skipSpaces: c, skipToLineEnd: l, skipEverythingButNewLine: C } = Tr(),
            m = Ei(),
            g = vi(),
            p = Fi(),
            f = gD(),
...
`
          ...
          function b($, W, ee) {
            let U = ee(W) - 1;
            (U = c($, U, { backwards: !0 })), (U = p($, U, { backwards: !0 })), (U = c($, U, { backwards: !0 }));
...
`);
    ...
    function ED(e, n, t, s) {
      ...
      if (typeof Reflect == "object" && typeof Reflect.decorate == "function") r = Reflect.decorate(e, n, t, s);
        ...
        for (var a = e.length - 1; a >= 0; a--) (u = e[a]) && (r = (i < 3 ? u(r) : i > 3 ? u(n, t, r) : u(n, t)) || r);
        ...
        for (; t; )
          try {
            if (
              ((s = 1),
              i &&
                (r = l[0] & 2 ? i.return : l[0] ? i.throw || ((r = i.return) && r.call(i), 0) : i.next) &&
                !(r = r.call(i, l[1])).done)
            )
              return r;
    ...
    function BD() {
      ...
      for (var s = Array(e), i = 0, n = 0; n < t; n++)
        for (var r = arguments[n], u = 0, a = r.length; u < a; u++, i++) s[i] = r[u];
      return s;
    }
    function Gt(e) {
            ...
            (e.apiDescriptor = {
              ...
              value(n) {
                ...
                return t.length === 0
                  ...
                  : "{ ".concat(
                      t
                        .map((s) => "".concat(e.apiDescriptor.key(s), ": ").concat(e.apiDescriptor.value(n[s])))
                        .join(", "),
                      " }"
                    );
              },
      ...
      Li = Z({
        "node_modules/vnopts/lib/handlers/deprecated/common.js"(e) {
          ...
          e.commonDeprecatedHandler = (t, s, i) => {
            ...
            return (
              s && u.push("we now treat it as ".concat(n.default.blue(typeof s == "string" ? r.key(s) : r.pair(s)))),
              u.join("; ") + "."
            );
          };
        },
        ...
        "node_modules/vnopts/lib/handlers/unknown/leven.js"(e) {
          ...
          e.levenUnknownHandler = (s, i, r) => {
            let { descriptor: u, logger: a, schemas: c } = r,
              l = ["Ignored unknown option ".concat(n.default.yellow(u.pair({ key: s, value: i })), ".")],
              C = Object.keys(c)
                .sort()
                .find((m) => t(s, m) < 3);
      ...
      Hn = Z({
        "node_modules/vnopts/lib/utils.js"(e) {
          ...
          function l(p, f) {
            ...
            return p === !1 ? !1 : p === !0 ? (h ? !0 : [{ value: f }]) : "value" in p ? [p] : p.length === 0 ? !1 : p;
          }
            ...
            s = class extends n.Schema {
              constructor(i) {
                ...
                this._choices = t.mapFromArray(
                  i.choices.map((r) => (r && typeof r == "object" ? r : { value: r })),
                  "value"
                );
              }
              expected(i) {
        ...
        "node_modules/vnopts/lib/normalize.js"(e) {
          ...
          var s = class {
            ...
            _applyNormalization(i, r) {
              let u = [],
                [a, c] = t.partition(Object.keys(i), (l) => l in this._utils.schemas);
              for (let l of a) {
                let C = this._utils.schemas[l],
                  m = C.preprocess(i[l], this._utils),
                  g = t.normalizeValidateResult(C.validate(m, this._utils), m);
                if (g !== !0) {
                  let { value: T } = g,
                ...
                let p = (T) => {
                  ...
                  f = (T) => {
                    let { value: A, redirectTo: b } = T,
                      v = t.normalizeDeprecatedResult(C.deprecated(A, this._utils), m, !0);
                    if (v !== !1)
                      if (v === !0)
                ...
                for (let { from: T, to: A } of N.redirect) f({ value: T, redirectTo: A });
              }
              for (let l of c) {
                let C = i[l],
        ...
        "src/main/options-normalizer.js"(e, n) {
          ...
          function a(g, p) {
            let {
              ...
              B = c(p, { isCLI: h, colorsModule: T, levenshteinDistance: A }),
              w = new t.Normalizer(B, { logger: f, unknown: b, descriptor: v }),
              I = f !== !1;
            I && u && (w._hasDeprecationWarned = u);
            let E = w.normalize(g);
            return (
              I && (u = w._hasDeprecationWarned), h && E["plugin-search"] === !1 && (E["plugin-search-dir"] = !1), E
            );
          }
          function c(g, p) {
            let { isCLI: f, colorsModule: h, levenshteinDistance: N } = p,
              T = [];
            f && T.push(t.AnySchema.create({ name: "_" }));
            for (let A of g)
              T.push(l(A, { isCLI: f, optionInfos: g, colorsModule: h, levenshteinDistance: N })),
                A.alias && f && T.push(t.AliasSchema.create({ name: A.alias, sourceName: A.name }));
            return T;
          }
          function l(g, p) {
            let { isCLI: f, optionInfos: h, colorsModule: N, levenshteinDistance: T } = p,
              { name: A } = g;
            ...
            switch (g.type) {
                  ...
                  (b.choices = g.choices.map((w) =>
                    typeof w == "object" && w.redirect
                      ? Object.assign(
                          Object.assign({}, w),
                          {},
                          { redirect: { to: { key: g.name, value: w.redirect } } }
                        )
                      : w
                  ));
                break;
              ...
              case "flag":
                (v = r({ colorsModule: N, levenshteinDistance: T })),
                  (b.flags = h.flatMap((w) =>
                    [w.alias, w.description && w.name, w.oppositeDescription && "no-".concat(w.name)].filter(Boolean)
                  ));
                break;
              case "path":
                v = t.StringSchema;
            ...
            if (
              (g.exception
                ? (b.validate = (w, I, E) => g.exception(w) || I.validate(w, E))
                : (b.validate = (w, I, E) => w === void 0 || I.validate(w, E)),
              g.redirect &&
                (B.redirect = (w) => (w ? { to: { key: g.redirect.option, value: g.redirect.value } } : void 0)),
            ...
            return g.array
              ? t.ArraySchema.create(
                  Object.assign(
                    Object.assign(Object.assign({}, f ? { preprocess: (w) => (Array.isArray(w) ? w : [w]) } : {}), B),
                    {},
              ...
              w = (m ? (0, n.default)(c, C) : c)
                ...
                .map((I, E) => {
                  ...
                  if (o) {
                    let F = "";
                    if (Array.isArray(o)) {
                      let S = I.slice(0, Math.max(o[0] - 1, 0)).replace(/[^\t]/g, " "),
                        k = o[1] || 1;
                      (F = [
                        `
 `,
                        ...
                        x && C.message && (F += " " + f(p.message, C.message));
                    }
        ...
        "src/main/parser.js"(e, n) {
          ...
          function l(g) {
            ...
            for (let f of g.plugins)
              if (!!f.parsers) for (let h of a(f.parsers)) Object.defineProperty(p, h, c(f.parsers, h));
            return p;
          }
          function C(g) {
            let p = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : l(g);
            if (typeof g.parser == "function") return { parse: g.parser, astFormat: "estree", locStart: r, locEnd: u };
...
` + T.codeFrame),
        ...
        "src/main/options.js"(e, n) {
          ...
          function c(m) {
            let g = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {},
              p = Object.assign({}, m),
              f = i({ plugins: m.plugins, showUnreleased: !0, showDeprecated: !0 }).options,
              h = Object.assign(
                Object.assign({}, a),
            ...
            let N = u(r.normalizeApiOptions(p, [f.find((v) => v.name === "parser")], { passThrough: !0, logger: !1 }));
            ...
            return (
              ...
              r.normalizeApiOptions(p, f, Object.assign({ passThrough: Object.keys(a) }, g))
            );
          }
          function l(m) {
            let { astFormat: g } = m;
          ...
          function C(m, g) {
            let p = t.basename(m).toLowerCase(),
              h = i({ plugins: g })
                ...
                .find(
                  (N) =>
                    (N.extensions && N.extensions.some((T) => p.endsWith(T))) ||
                    (N.filenames && N.filenames.some((T) => T.toLowerCase() === p))
                );
      ...
      Qe = Z({
        "src/main/comments.js"(e, n) {
          ...
          var t = Ut(),
            {
              builders: { line: s, hardline: i, breakParent: r, indent: u, lineSuffix: a, join: c, cursor: l },
            } = Le(),
            {
              hasNewline: C,
              skipNewline: m,
          ...
          function B(O, R, M, H) {
            ...
            for (let [V, oe] of se.entries()) {
              ...
              if (
                (W
                  ? (ve = [oe])
                  : ((K.enclosingNode = q), (K.precedingNode = Ee), (K.followingNode = le), (ve = [K, ue, Q, de, ge])),
                I(ue, Q, se, V))
              )
          ...
          function o(O, R) {
            ...
            if (P.isBlockComment && P.isBlockComment(M)) {
              let U = C(G, $(M)) ? (C(G, re(M), { backwards: !0 }) ? i : s) : " ";
              H.push(U);
            } else H.push(i);
            let ee = m(G, g(G, $(M)));
          ...
          var r = class {
            ...
            findAncestor(u) {
              ...
              for (; l; ) {
                let C = null;
                if (
                  (typeof c == "number" && ((C = c), (c = this.stack[a--]), (l = this.stack[a--])),
                  c !== null && u(l, c, C))
                )
                  return l;
      ...
      sm = Z({
        "src/main/multiparser.js"(e, n) {
          ...
          function u(a, c, l, C) {
            let { stripTrailingHardline: m = !1 } = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : {},
              g = s(
                Object.assign(Object.assign(Object.assign({}, l), c), {}, { parentParser: l.parser, originalText: a }),
                { passThrough: !0 }
              ),
              p = Gn().parse(a, g),
              { ast: f } = p;
      ...
      am = Z({
        "src/main/ast-to-doc.js"(e, n) {
          ...
          function l(m, g) {
            let { originalText: p, [Symbol.for("comments")]: f, locStart: h, locEnd: N } = g,
              T = h(m),
              A = N(m),
              b = new Set();
      ...
      om = Z({
        "src/main/core.js"(e, n) {
          ...
          var { diffArrays: t } = rD(),
            ...
            { guessEndOfLine: u, convertEndOfLineToChars: a, countEndOfLineChars: c, normalizeEndOfLine: l } = On(),
            C = Mi().normalize,
            m = nm(),
            g = Qe(),
            p = Gn(),
          ...
          function b(d, y) {
            ...
            if (!d || d.trim().length === 0) return { formatted: "", cursorOffset: -1, comments: [] };
          ...
          function v(d, y) {
            let { ast: o, text: x } = p.parse(d, y),
              { rangeStart: F, rangeEnd: S } = h.calculateRange(x, y, o),
              k = x.slice(F, S),
              _ = Math.min(
                F,
                x.lastIndexOf(
...
`
          ...
          function w(d, y) {
            ...
            return (
              ...
              (x = B(d, x, 0)),
              (F = B(d, F, d.length)),
              Object.assign(Object.assign({}, y), {}, { cursorOffset: o, rangeStart: x, rangeEnd: F })
            );
          }
          function I(d, y) {
            let { cursorOffset: o, rangeStart: x, rangeEnd: F, endOfLine: S } = w(d, y),
              k = d.charAt(0) === N;
...
`
            ...
            return {
              ...
              options: w(
                d,
                Object.assign(Object.assign({}, y), {}, { cursorOffset: o, rangeStart: x, rangeEnd: F, endOfLine: S })
              ),
            };
          }
          function E(d, y) {
            ...
            return (
              F.rangeStart > 0 || F.rangeEnd < x.length
                ...
                : (!F.requirePragma &&
                  ...
                  (S = b(x, F))),
              o && ((S.formatted = N + S.formatted), S.cursorOffset >= 0 && S.cursorOffset++),
              S
            );
          }
          n.exports = {
...
`)
          ...
          function fe(L, De) {
            return (
              ((L.type === "TemplateLiteral" && we(L)) || (L.type === "TaggedTemplateExpression" && we(L.quasi))) &&
          ...
          function he(L, De) {
            ...
            let ke = ($e) => he($e, De + 1),
              We =
                (L.type === "Literal" && "regex" in L && L.regex.pattern) || (L.type === "RegExpLiteral" && L.pattern);
            return We && c(We) > 5
              ? !1
              : L.type === "Literal" ||
                L.type === "BigIntLiteral" ||
...
`)
              ...
              : rt(L)
              ? (L.type === "ImportExpression" || he(L.callee, De)) && Be(L).every(ke)
              : q(L)
          ...
          function Ke(L) {
            ...
            return (
              ...
              Array.isArray(L.parameters) ? De.push(...L.parameters) : Array.isArray(L.params) && De.push(...L.params),
          ...
          function v(d, y, o) {
            ...
            return (
              O &&
                (_ = _.map(
                  (R) =>
                    p(R, Object.assign(Object.assign({}, o), {}, { printWidth: Number.POSITIVE_INFINITY })).formatted
                )),
              k.push(m, "`"),
              d.each((R) => {
                let M = R.getName();
              ...
              let k = [],
                _ = S.map(
                  (P) =>
                    ...
                    p(
                      P,
                      Object.assign(Object.assign({}, y), {}, { printWidth: Number.POSITIVE_INFINITY, endOfLine: "lf" })
                    ).formatted +
                    "}"
                ),
...
`) && O.push({ hasLineBreak: !1, cells: [] });
      ...
      Dm = Z({
        "src/language-js/embed/markdown.js"(e, n) {
          ...
          ae();
          var {
              builders: { indent: t, softline: s, literalline: i, dedentToRoot: r },
            } = Le(),
          ...
          function a(l, C, m) {
            ...
            let N = u(m(p, { parser: "markdown", __inJsTemplate: !0 }, { stripTrailingHardline: !0 }), !0);
        ...
        "src/language-js/embed/css.js"(e, n) {
          ...
          function C(p, f, h) {
            let N = p.getValue(),
              ...
              v = h(b, { parser: "scss" }, { stripTrailingHardline: !0 }),
              B = l(p, f);
            return m(v, N, B);
          }
          function m(p, f, h) {
            ...
            let h = 0,
              N = u(c(p), (T) =>
                typeof T != "string" || !T.includes("@prettier-placeholder")
                  ? T
                  : T.split(/@prettier-placeholder-(\d+)-id/).map((A, b) => (b % 2 === 0 ? a(A) : (h++, f[A])))
              );
      ...
      dm = Z({
        "src/language-js/embed/graphql.js"(e, n) {
          ...
          var {
            ...
            { escapeTemplateCharacters: r, printTemplateExpressions: u } = It();
          function a(l, C, m) {
            let g = l.getValue(),
              p = g.quasis.length;
...
`),
              ...
              let y = null;
              d ? (y = c(B)) : (y = m(v, { parser: "graphql" }, { stripTrailingHardline: !0 })),
                y
                  ? ((y = r(y, !1)), !A && E && h.push(""), h.push(y), !b && D && h.push(""))
                  : !A && !b && E && h.push(""),
                I && h.push(I);
            }
            return ["`", t([i, s(i, h)]), i, "`"];
          ...
          function c(l) {
            let C = [],
              m = !1,
              g = l.map((p) => p.trim());
            for (let [p, f] of g.entries()) f !== "" && (g[p - 1] === "" && m ? C.push([i, f]) : C.push(f), (m = !0));
      ...
      gm = Z({
        "src/language-js/embed/html.js"(e, n) {
          ...
          var {
            ...
            { printTemplateExpressions: a, uncookTemplateElementValue: c } = It(),
            l = 0;
          function C(m, g, p, f, h) {
            ...
            let b = (x) => "PRETTIER_HTML_PLACEHOLDER_".concat(x, "_").concat(A, "_IN_JS"),
              v = T.quasis.map((x, F, S) => (F === S.length - 1 ? x.value.cooked : x.value.cooked + b(F))).join(""),
              B = a(m, g);
      ...
      ym = Z({
        "src/language-js/embed.js"(e, n) {
          "use strict";
          ae();
          var { hasComment: t, CommentCheckFlags: s, isObjectProperty: i } = Xe(),
            r = Dm(),
            u = mm(),
            a = dm(),
            c = gm();
          ...
          function C(E, D, d, y) {
            ...
            if (!!x) {
              ...
              if (x === "html" || x === "angular") return c(E, D, d, y, { parser: x });
            }
          }
          function m(E) {
            let D = E.getValue(),
          ...
          function g(E) {
            ...
            return (
              (y &&
                ...
                y.openingElement.attributes.some((o) => o.name.name === "jsx")) ||
              (d && d.type === "TaggedTemplateExpression" && d.tag.type === "Identifier" && d.tag.name === "css") ||
              (d &&
                d.type === "TaggedTemplateExpression" &&
                d.tag.type === "MemberExpression" &&
                d.tag.object.name === "css" &&
                (d.tag.property.name === "global" || d.tag.property.name === "resolve"))
            );
          }
          function p(E) {
            return E.match(
              (D) => D.type === "TemplateLiteral",
              (D, d) => D.type === "ArrayExpression" && d === "elements",
              (D, d) => i(D) && D.key.type === "Identifier" && D.key.name === "styles" && d === "value",
              ...h
            );
          }
          function f(E) {
            return E.match(
              (D) => D.type === "TemplateLiteral",
              (D, d) => i(D) && D.key.type === "Identifier" && D.key.name === "template" && d === "value",
              ...h
            );
          }
          var h = [
                ...
                return (
                  ...
                  (d.callee.type === "MemberExpression" &&
                    ((d.callee.object.type === "MemberExpression" &&
                      (A(d.callee.object.object) || b(d.callee.object))) ||
                      (d.callee.object.type === "CallExpression" && A(d.callee.object.callee))))
                );
              case "Identifier":
                return d.name === "css";
              default:
              ...
              (d &&
                ((d.type === "TaggedTemplateExpression" &&
                  ((d.tag.type === "MemberExpression" &&
                    ...
                    (d.tag.type === "Identifier" && (d.tag.name === "gql" || d.tag.name === "graphql")))) ||
                  (d.type === "CallExpression" && d.callee.type === "Identifier" && d.callee.name === "graphql")))
            );
          }
          function B(E, D) {
        ...
        "src/language-js/clean.js"(e, n) {
          ...
          function r(u, a, c) {
            if (
              ...
              (u.type === "BigIntLiteral" || u.type === "Literal") && a.bigint && (a.bigint = a.bigint.toLowerCase()),
            ...
            if (
              ...
              u.type === "JSXElement" &&
                ...
                u.openingElement.attributes.some((C) => C.name.name === "jsx"))
            )
              ...
              u.type === "TemplateLiteral" &&
                ((u.leadingComments &&
                  u.leadingComments.some(
                    (m) => t(m) && ["GraphQL", "HTML"].some((g) => m.value === " ".concat(g, " "))
                  )) ||
                  (c.type === "CallExpression" && c.callee.name === "graphql") ||
                  !u.leadingComments) &&
                i(a),
...
`);
      ...
      eo = Z({
        "src/language-js/pragma.js"(e, n) {
          "use strict";
          ae();
          var { parseWithComments: t, strip: s, extract: i, print: r } = Sm(),
          ...
          function C(m) {
            let { shebang: g, text: p, pragmas: f, comments: h } = c(m),
              N = s(p),
              T = r({ pragmas: Object.assign({ format: "" }, f), comments: h.trimStart() });
            return (
              (g
                ? "".concat(
                    g,
...
`) +
        ...
        "src/language-js/comments.js"(e, n) {
            ...
            if (
              ...
              if (j) {
                ...
                for (let Ce of ["implements", "extends", "mixins"])
                  if (z[Ce] && j === z[Ce][0])
                    return (
                      te && (te === z.id || te === z.typeParameters || te === z.superClass) ? c(te, Y) : l(z, Y, Ce), !0
                    );
              }
            }
            return !1;
          ...
          function ee(X) {
            ...
            return (z &&
              te &&
              r(j, Y, o) === "(" &&
              (z.type === "Property" || z.type === "TSDeclareMethod" || z.type === "TSAbstractMethodDefinition") &&
              te.type === "Identifier" &&
              z.key === te &&
              r(j, te, o) !== ":") ||
              (te &&
          ...
          function se(X) {
            ...
            return r(z, Y, o) !== ")"
              ? !1
              : te && ((ce(te) && g(te).length === 0) || (A(te) && b(te).length === 0))
              ? (l(te, Y), !0)
              : te &&
          ...
          function V(X) {
            ...
            if (
              ...
              (te && (te.type === "Identifier" || te.type === "AssignmentPattern") && z && ce(z) && r(Ce, Y, o) === ")")
            )
              return c(te, Y), !0;
          ...
          function le(X) {
            ...
            return z && (z.type === "UnionTypeAnnotation" || z.type === "TSUnionType")
              ? (p(Y) && ((j.prettierIgnore = !0), (Y.unignore = !0)), te ? (c(te, Y), !0) : !1)
              : (j &&
          ...
          function ge(X) {
            let { comment: Y, precedingNode: te, enclosingNode: z, text: j } = X;
            return te && te.type === "ImportSpecifier" && z && z.type === "ImportDeclaration" && s(j, o(Y))
              ? (c(te, Y), !0)
              : !1;
          }
          function ve(X) {
              ...
              ((Y && (f(Y) || h(Y) || (v(te) && z(Y)))) ||
                (te &&
                  (te.type === "JSXSpreadAttribute" ||
                    ...
                    te.type === "TSUnionType" ||
                    ((te.type === "ClassDeclaration" || te.type === "ClassExpression") && te.superClass === Y)))) &&
        ...
        "src/language-js/needs-parens.js"(e, n) {
          ...
          function N(I, E) {
            ...
            if (y.type === "Identifier")
              return !!(
                (y.extra && y.extra.parenthesized && /^PRETTIER_HTML_PLACEHOLDER_\d+_\d+_IN_JS$/.test(y.name)) ||
                (d === "left" && y.name === "async" && D.type === "ForOfStatement" && !D.await)
              );
            switch (D.type) {
            ...
            switch (y.type) {
              case "UpdateExpression":
                if (D.type === "UnaryExpression")
                  return (
                    y.prefix &&
                    ((y.operator === "++" && D.operator === "+") || (y.operator === "--" && D.operator === "-"))
                  );
              case "UnaryExpression":
                switch (D.type) {
                  case "UnaryExpression":
                ...
                switch (D.type) {
                  ...
                  case "BinaryExpression": {
                    ...
                    let F = g(o),
                      S = D.operator,
                      k = g(S);
                    return k > F || (d === "right" && k === F) || (k === F && !m(S, o))
                      ? !0
                      : k < F && o === "%"
                      ? S === "+" || S === "-"
                      : !!l(S);
              ...
              case "TSTypeOperator":
                return (
                  ...
                  D.type === "TSRestType" ||
                  (d === "objectType" && D.type === "TSIndexedAccessType") ||
              ...
              case "UnionTypeAnnotation":
                return (
                  ...
                  (d === "objectType" && (D.type === "IndexedAccessType" || D.type === "OptionalIndexedAccessType"))
                );
              ...
              case "FunctionTypeAnnotation": {
                ...
                return (
                  ...
                  (d === "objectType" && (o.type === "IndexedAccessType" || o.type === "OptionalIndexedAccessType")) ||
                  o.type === "NullableTypeAnnotation" ||
                  (D.type === "FunctionTypeParam" &&
                    D.name === null &&
                    i(y).some((x) => x.typeAnnotation && x.typeAnnotation.type === "NullableTypeAnnotation"))
                );
              }
              ...
              case "AssignmentExpression": {
                let o = I.getParentNode(1);
                return d === "body" && D.type === "ArrowFunctionExpression"
                  ? !0
                  : (d === "key" && (D.type === "ClassProperty" || D.type === "PropertyDefinition") && D.computed) ||
                    ((d === "init" || d === "update") && D.type === "ForStatement")
                  ? !1
                  : D.type === "ExpressionStatement"
                  ? y.left.type === "ObjectPattern"
                  : !(
                      (d === "key" && D.type === "TSPropertySignature") ||
              ...
              case "OptionalCallExpression": {
                ...
                if (
                  ...
                  (d === "callee" && (D.type === "CallExpression" || D.type === "NewExpression")) ||
                  (D.type === "TSNonNullExpression" && o.type === "MemberExpression" && o.object === D)
                )
                  return !0;
              }
              case "CallExpression":
              ...
              case "BindExpression":
                return (
                  (d === "callee" && (D.type === "BindExpression" || D.type === "NewExpression")) ||
                  (d === "object" && f(D))
                );
              case "NGPipeExpression":
                return !(
              ...
              case "JSXElement":
                return (
                  d === "callee" ||
                  (d === "left" && D.type === "BinaryExpression" && D.operator === "<") ||
                  (D.type !== "ArrayExpression" &&
          ...
          function b(I) {
            return c(
              I,
              (E) =>
                (E.type === "ObjectTypeAnnotation" && c(E, (D) => D.type === "FunctionTypeAnnotation" || void 0)) ||
                void 0
            );
          }
          function v(I) {
          ...
          function w(I, E) {
            ...
            return D.type === "FunctionExpression" || D.type === "ClassExpression"
              ...
              : !a(D) || (d.type !== "ExportDefaultDeclaration" && N(I, E))
              ? !1
      ...
      bm = Z({
        "src/language-js/print/html-binding.js"(e, n) {
          ...
          ae();
          var {
            builders: { join: t, line: s, group: i, softline: r, indent: u },
          } = Le();
          function a(l, C, m) {
            let g = l.getValue();
            if ((C.__onHtmlBindingRoot && l.getName() === null && C.__onHtmlBindingRoot(g, C), g.type === "File")) {
              ...
              if (C.__isVueBindings) return l.call((p) => t([",", s], p.map(m, "params")), "program", "body", 0);
            }
          }
          function c(l) {
            switch (l.type) {
      ...
      Jn = Z({
        "src/language-js/print/binaryish.js"(e, n) {
          ...
          var { printComments: t } = Qe(),
            { getLast: s } = Ge(),
            {
              builders: { join: i, line: r, softline: u, group: a, indent: c, align: l, ifBreak: C, indentIfBreak: m },
            ...
            let P =
                ...
                (k.type !== "NGPipeExpression" &&
                  ((_.type === "NGRoot" && F.parser === "__ng_binding") ||
                    (_.type === "NGMicrosyntaxExpression" && O.type === "NGMicrosyntax" && O.body.length === 1))) ||
              ...
              switch (h.type) {
                ...
                case "NGMicrosyntaxKeyedExpression": {
                  let N = g.getName(),
                    ...
                    A =
                      C(h, N, T) ||
                      (((N === 1 && (h.key.name === "then" || h.key.name === "else")) ||
                        (N === 2 &&
                          h.key.name === "else" &&
                          T.body[N - 1].type === "NGMicrosyntaxKeyedExpression" &&
      ...
      Bm = Z({
        "src/language-js/print/jsx.js"(e, n) {
          ...
          function S(q, le, ue, Q) {
            return q
              ? ""
              : (ue.type === "JSXElement" && !ue.closingElement) || (Q && Q.type === "JSXElement" && !Q.closingElement)
              ? le.length === 1
                ? u
                : r
              : u;
            ...
            if ((de.push(ue("name")), Q.value)) {
              ...
              if (B(Q.value)) {
                let xe = A(Q.value)
                    ...
                    .replace(/&apos;/g, "'")
                    .replace(/&quot;/g, '"'),
                  { escaped: we, quote: fe, regex: pe } = N(xe, le.jsxSingleQuote ? "'" : '"');
              ...
              de = (ge, ve) =>
                ...
                (!I(ge) &&
                  (ge.type === "ArrayExpression" ||
                    ...
                    (ge.type === "AwaitExpression" && (de(ge.argument, ge) || ge.argument.type === "JSXElement")) ||
                    v(ge) ||
...
`) &&
            ...
            let ge = Q.attributes.length > 0 && I(h(Q.attributes), E.Trailing),
              ve =
...
\r	`,
          ...
          function K(q) {
            return (
              q.type === "JSXExpressionContainer" && b(q.expression) && q.expression.value === " " && !I(q.expression)
            );
          }
          function Ee(q) {
            let le = q.getValue(),
      ...
      ot = Z({
        "src/language-js/print/misc.js"(e, n) {
          ...
          function a(h) {
            let N = h.getValue();
            return !N.optional || (N.type === "Identifier" && N === h.getParentNode().key)
              ? ""
              : N.type === "OptionalCallExpression" || (N.type === "OptionalMemberExpression" && N.computed)
              ? "?."
              : "?";
          }
          function c(h) {
            return h.getValue().definite ||
              h.match(void 0, (N, T) => T === "id" && N.type === "VariableDeclarator" && N.definite)
              ? "!"
              : "";
          }
          function l(h, N, T) {
      ...
      zt = Z({
        "src/language-js/print/array.js"(e, n) {
          ...
          var { printDanglingComments: t } = Qe(),
            {
              builders: { line: s, softline: i, hardline: r, group: u, indent: a, ifBreak: c, fill: l },
            } = Le(),
          ...
          function B(D, d, y) {
            let o = D.getValue(),
              ...
              S = "]";
            if (o.elements.length === 0) p(o, f.Dangling) ? x.push(u([F, t(D, d), i, S])) : x.push(F, S);
            else {
              let k = C(o.elements),
                ...
                H = w(o, d),
                P = _ ? (O ? "," : g(d) ? (H ? c(",", "", { groupId: R }) : c(",")) : "") : "";
              x.push(
                u([F, a([i, H ? E(D, d, y, P) : [I(D, d, "elements", y), P], t(D, d, !0)]), i, S], {
                  shouldBreak: M,
                  id: R,
                })
              );
            ...
            return (
              ...
              D.elements.every(
                (y) =>
                  ...
                  !p(y, f.Trailing | f.Line, (o) => !m(d.originalText, A(o), { backwards: !0 }))
              )
            );
          }
          function I(D, d, y, o) {
          ...
          function E(D, d, y, o) {
            ...
            return (
              D.each((F, S, k) => {
                let _ = S === k.length - 1;
                x.push([y(), _ ? o : ","]),
                  _ || x.push(h(F.getValue(), d) ? [r, r] : p(k[S + 1], f.Leading | f.Line) ? r : s);
              }, "elements"),
              l(x)
            );
          }
      ...
      no = Z({
        "src/language-js/print/call-arguments.js"(e, n) {
          ...
          function x(M, H, P) {
            ...
            function V() {
              return B(["(", w([A, ...ne]), se, A, ")"], { shouldBreak: !0 });
            }
            ...
            if (oe || K) {
                ...
                M.try(() => {
                  p(M, (le, ue) => {
                    oe &&
                      ue === 0 &&
                      (q = [
                        [P([], { expandFirstArg: !0 }), ne.length > 1 ? "," : "", ee ? b : A, ee ? b : ""],
                        ...ne.slice(1),
                      ]),
              ...
              return [
                ...
                I([
                  ["(", ...q, ")"],
                  oe
                    ? ["(", B(q[0], { shouldBreak: !0 }), ...q.slice(1), ")"]
                    : ["(", ...ne.slice(0, -1), B(s(q), { shouldBreak: !0 }), ")"],
                  V(),
                ]),
              ];
            }
            ...
            return (
              ...
              (M.type === "ArrowFunctionExpression" &&
                ...
                (M.body.type === "BlockStatement" ||
                  ...
                  (!H && (h(M.body) || M.body.type === "ConditionalExpression")) ||
                  l(M.body))) ||
              M.type === "DoExpression" ||
      ...
      uo = Z({
        "src/language-js/print/member.js"(e, n) {
          ...
          var {
            ...
            { isNumericLiteral: u, isMemberExpression: a, isCallExpression: c } = Xe(),
          ...
          function C(g, p, f) {
            ...
            let b = f("object"),
              ...
              B =
                ...
                h.computed ||
                (h.object.type === "Identifier" && h.property.type === "Identifier" && !a(N)) ||
      ...
      Nm = Z({
        "src/language-js/print/member-chain.js"(e, n) {
          ...
          ae();
          var { printComments: t } = Qe(),
            { getLast: s, isNextLineEmptyAfterIndex: i, getNextNonSpaceNonCommentCharacterIndex: r } = Ge(),
            u = kt(),
            {
              isCallExpression: a,
            ...
            { locEnd: T } = nt(),
            {
              builders: { join: A, hardline: b, group: v, indent: B, conditionalGroup: w, breakParent: I, label: E },
              utils: { willBreak: D },
            } = Le(),
            d = no(),
          ...
          function S(k, _, O) {
            ...
            function G(me) {
              ...
              a(ce) && (m(ce.callee) || a(ce.callee))
                ? (H.unshift({ node: ce, printed: [t(me, [o(me), x(me, _, O), d(me, _, O)], _), P(ce) ? b : ""] }),
                  me.call((he) => G(he), "callee"))
                : m(ce)
                ? (H.unshift({ node: ce, needsParens: u(me, _), printed: t(me, c(ce) ? y(me, _, O) : F(me, _, O), _) }),
            ...
            let re = k.getValue();
            H.unshift({ node: re, printed: [o(k), x(k, _, O), d(k, _, O)] }),
            ...
            for (
              ...
              (H[ee].node.type === "TSNonNullExpression" ||
                a(H[ee].node) ||
                (c(H[ee].node) && H[ee].node.computed && g(H[ee].node.property)));
              ++ee
            )
              W.push(H[ee]);
            ...
            for (; ee < H.length; ++ee) {
              ...
              (a(H[ee].node) || H[ee].node.type === "ImportExpression") && (U = !0),
                W.push(H[ee]),
                f(H[ee].node, h.Trailing) && ($.push(W), (W = []), (U = !1));
            }
            W.length > 0 && $.push(W);
            function ne(me) {
            ...
            function V(me) {
              ...
              if (me[0].length === 1) {
                let J = me[0][0].node;
                return (
                  J.type === "ThisExpression" || (J.type === "Identifier" && (ne(J.name) || (M && se(J.name)) || ce))
                );
              }
              let he = s(me[0]).node;
      ...
      so = Z({
        "src/language-js/print/call-expression.js"(e, n) {
          ...
          var {
            ...
            p = Nm(),
            f = no(),
            { printOptionalToken: h, printFunctionTypeParameters: N } = ot();
          function T(b, v, B) {
            let w = b.getValue(),
              I = b.getParentNode(),
            ...
            if (
              y.length > 0 &&
              ((!D && !E && A(w, I)) || (y.length === 1 && C(y[0], v.originalText)) || (!E && m(w, I)))
            ) {
              let F = [];
              return (
                g(b, () => {
            ...
            if (
              ...
              !D && !E && c(w.callee) && !b.call((F) => i(F, v), "callee"))
            )
              return p(b, v, B);
            let x = [
              E ? "new " : "",
            ...
            if (b.callee.name === "define") {
              ...
              return (
                ...
                (B.length === 1 ||
                  ...
                  (B.length === 3 && l(B[0]) && B[1].type === "ArrayExpression"))
              );
            }
            return !1;
          }
      ...
      Xt = Z({
        "src/language-js/print/assignment.js"(e, n) {
          ...
          var { isNonEmptyArray: t, getStringWidth: s } = Ge(),
            {
              builders: { line: i, group: r, indent: u, indentIfBreak: a, lineSuffixBoundary: c },
          ...
          function S(V) {
            if (_(V)) {
              ...
              return (
                ...
                oe.properties.some((K) => I(K) && (!K.shorthand || (K.value && K.value.type === "AssignmentPattern")))
              );
            }
            return !1;
          }
          ...
          function ee(V, oe) {
            ...
            if (
              ...
              return !0;
            let q =
              (V.type === "Literal" && "regex" in V && V.regex.pattern) || (V.type === "RegExpLiteral" && V.pattern);
            return q
              ? q.length <= Ee
              : f(V)
              ? v(V).length <= Ee
...
`)
      ...
      wr = Z({
        "src/language-js/print/function-parameters.js"(e, n) {
          ...
          var { getNextNonSpaceNonCommentCharacter: t } = Ge(),
            ...
            {
              builders: { line: i, hardline: r, softline: u, group: a, indent: c, ifBreak: l },
          ...
          function d(F, S, k, _, O) {
            ...
            if (
              (p(F, (U, ne) => {
                ...
                se && R.rest && $.push("..."),
                  $.push(S()),
                  !se && ($.push(","), G || re ? $.push(" ") : w(M[ne], k) ? $.push(r, r) : $.push(i));
              }),
              _)
            ) {
          ...
          function y(F) {
            ...
            return (
              ...
              (k.type === "ObjectPattern" ||
                ...
                (k.type === "Identifier" &&
                  k.typeAnnotation &&
                  (k.typeAnnotation.type === "TypeAnnotation" || k.typeAnnotation.type === "TSTypeAnnotation") &&
      ...
      _r = Z({
        "src/language-js/print/type-annotation.js"(e, n) {
          ...
          var { printComments: t, printDanglingComments: s } = Qe(),
            ...
            {
              builders: { group: r, join: u, line: a, softline: c, indent: l, align: C, ifBreak: m },
            } = Le(),
            g = kt(),
            { locStart: p } = nt(),
            {
            ...
            { printFunctionParameters: v, shouldGroupFunctionParameters: B } = wr(),
          ...
          function y(S, k, _) {
            let O = S.getValue(),
              ...
              M =
                ...
                !(
                  (R.type === "TypeAlias" || R.type === "VariableDeclarator" || R.type === "TSTypeAliasDeclaration") &&
                  N(k.originalText, O)
                ),
              H = I(O),
              P = S.map(($) => {
      ...
      Pr = Z({
        "src/language-js/print/type-parameters.js"(e, n) {
          ...
          var { printDanglingComments: t } = Qe(),
            {
              builders: { join: s, line: i, hardline: r, softline: u, group: a, indent: c, ifBreak: l },
            } = Le(),
            {
              isTestCall: C,
              hasComment: m,
          ...
          function B(E, D, d, y) {
            ...
            if (
              ...
              (F ||
                o[y].length === 0 ||
                (o[y].length === 1 && (o[y][0].type === "NullableTypeAnnotation" || A(o[y][0]))))
            )
        ...
        "src/language-js/print/property.js"(e, n) {
          ...
          function g(f, h, N) {
            ...
            if (
              ...
              (h.parser === "json" || (h.quoteProps === "consistent" && m.get(A)))
            ) {
              let v = s(JSON.stringify(b.type === "Identifier" ? b.name : b.value.toString()), h);
              return f.call((B) => t(B, v, h), "key");
            }
            return c(T, h) && (h.quoteProps === "as-needed" || (h.quoteProps === "consistent" && !m.get(A)))
              ? f.call((v) => t(v, /^\d/.test(b.value) ? i(b.value) : b.value, h), "key")
              : N("key");
          }
          function p(f, h, N) {
      ...
      Ir = Z({
        "src/language-js/print/function.js"(e, n) {
          ...
          ae();
          var t = Ut(),
            { printDanglingComments: s, printCommentsSeparately: i } = Qe(),
            r = st(),
            ...
            { locEnd: R } = nt(),
            { printFunctionParameters: M, shouldGroupFunctionParameters: H } = wr(),
          ...
          function U(ue, Q, de, ge, ve, xe) {
            ...
            return (
              xe.body.type === "SequenceExpression" && (ve = l(["(", C([c, ve]), c, ")"])),
              l([
                l(C([pe || me ? c : "", l(p([" =>", a], de), { shouldBreak: ge })]), { id: J, shouldBreak: he }),
                " =>",
          ...
          function ne(ue, Q, de, ge) {
            ...
            if (
              ...
              return l([...pe, " ", we]);
            if (ve.body.type === "SequenceExpression") return l([...pe, l([" (", C([c, we]), c, ")"])]);
          ...
          function K(ue, Q, de) {
            ...
            ge.argument &&
              (le(Q, ge.argument)
                ...
                ? xe.push(l([m(" (", " "), C([c, de("argument")]), c, m(")")]))
                : xe.push(" ", de("argument")));
            let we = o(ge),
              fe = r(we),
              pe = fe && d(fe);
      ...
      Un = Z({
        "src/language-js/print/decorators.js"(e, n) {
          ...
          var { isNonEmptyArray: t, hasNewline: s } = Ge(),
            {
              builders: { line: i, hardline: r, join: u, breakParent: a, group: c },
            } = Le(),
      ...
      Yt = Z({
        "src/language-js/print/class.js"(e, n) {
          ...
          var { isNonEmptyArray: t, createGroupIdMapper: s } = Ge(),
            ...
            {
              builders: { join: u, line: a, hardline: c, softline: l, group: C, indent: m, ifBreak: g },
            } = Le(),
          ...
          function I(k, _, O) {
            ...
            if ((R.id && P.push(" ", O("id")), P.push(O("typeParameters")), R.superClass)) {
              let re = [x(k, _, O), O("superTypeParameters")],
                $ = k.call((W) => ["extends ", i(W, re, _)], "superClass");
              H ? G.push(a, C($)) : G.push(" ", $);
      ...
      ao = Z({
        "src/language-js/print/interface.js"(e, n) {
          ...
          var { isNonEmptyArray: t } = Ge(),
            {
              builders: { join: s, line: i, group: r, indent: u, ifBreak: a },
            } = Le(),
          ...
          function p(f, h, N) {
            ...
            T.declare && A.push("declare "),
              T.type === "TSInterfaceDeclaration" && A.push(T.abstract ? "abstract " : "", g(f, h, N)),
              A.push("interface");
            let b = [],
              v = [];
            ...
            return (
              t(T.extends) &&
                v.push(
                  ...
                  "extends ",
                  (T.extends.length === 1 ? l : u)(s([",", i], f.map(N, "extends")))
                ),
      ...
      io = Z({
        "src/language-js/print/module.js"(e, n) {
          ...
          var { isNonEmptyArray: t } = Ge(),
            {
              builders: { softline: s, group: i, indent: r, join: u, line: a, ifBreak: c, hardline: l },
            } = Le(),
            ...
            { hasDecoratorsBeforeExport: b, printDecoratorsBeforeExport: v } = Un();
          function B(S, k, _) {
            let O = S.getValue(),
              R = k.semi ? ";" : "",
              M = [],
              { importKind: H } = O;
            return (
              M.push("import"), H && H !== "value" && M.push(" ", H), M.push(d(S, k, _), D(S, k, _), o(S, k, _), R), M
            );
          }
          function w(S, k, _) {
            let O = S.getValue(),
            ...
            return (
              ...
              m(O, g.Dangling) && (R.push(" ", C(S, k, !0)), f(O) && R.push(l)),
              P
                ? R.push(" ", _("declaration"))
                : R.push(H === "type" ? " type" : "", d(S, k, _), D(S, k, _), o(S, k, _)),
              E(O, k) && R.push(";"),
              R
            );
          }
          ...
          function x(S, k, _) {
            ...
            let P = R.startsWith("Import"),
              ...
              U = "";
            return (
              R === "ExportNamespaceSpecifier" || R === "ImportNamespaceSpecifier" ? (ee = "*") : $ && (ee = _(G)),
              W && !F(O) && (U = _(re)),
              M.push(ee, ee && U ? " as " : "", U),
              M
            );
      ...
      zn = Z({
        "src/language-js/print/object.js"(e, n) {
          ...
          var { printDanglingComments: t } = Qe(),
            {
              builders: { line: s, softline: i, group: r, indent: u, ifBreak: a, hardline: c },
            } = Le(),
            { getLast: l, hasNewlineInRange: C, hasNewline: m, isNonEmptyArray: g } = Ge(),
            { shouldPrintComma: p, hasComment: f, getComments: h, CommentCheckFlags: N, isNextLineEmpty: T } = Xe(),
          ...
          function D(d, y, o) {
            ...
            let O = _.map((V) => F[V][0]).sort((V, oe) => A(V) - A(oe))[0],
              ...
              M =
                k &&
                R &&
                (R.type === "InterfaceDeclaration" || R.type === "DeclareInterface" || R.type === "DeclareClass") &&
                d.getName() === "body",
              H =
                F.type === "TSInterfaceBody" ||
                M ||
            ...
            if (F.inexact) {
              ...
              if (f(F, N.Dangling)) {
                let oe = f(F, N.Line);
                V = [t(d, y, !0), oe || m(y.originalText, b(l(h(F)))) ? c : s, "..."];
              } else V = ["..."];
              ee.push([...W, ...V]);
            }
            let U = l(F[S]),
      ...
      wm = Z({
        "src/language-js/print/flow.js"(e, n) {
          ...
          var t = Ut(),
            ...
            {
              builders: { hardline: u, softline: a, group: c, indent: l },
            } = Le(),
            {
            ...
            { printExportDeclaration: o, printExportAllDeclaration: x } = io(),
          ...
          function M(P, G, re) {
            ...
            switch ($.type) {
              ...
              case "EnumSymbolBody": {
                ...
                if ($.members.length === 0 && !$.hasUnknownMembers) ee.push(c(["{", s(P, G), a, "}"]));
                else {
                  let U =
                    $.members.length > 0 ? [u, F(P, G, "members", re), $.hasUnknownMembers || f(G) ? "," : ""] : [];
                  ee.push(c(["{", l([...U, ...($.hasUnknownMembers ? [u, "..."] : [])]), s(P, G, !0), u, "}"]));
                }
                return ee;
              }
              ...
              case "TypeParameterInstantiation": {
                ...
                if (G.parser === "flow") {
                  ...
                  if (V !== -1 && oe !== -1) {
                    ...
                    if (K.startsWith("::") && !K.includes("/*") && !K.includes("*/")) return ["/*:: ", U, " */"];
                  }
                }
                return U;
              }
      ...
      oo = Z({
        "src/language-js/print/ternary.js"(e, n) {
          ...
          var { hasNewlineInRange: t } = Ge(),
            { isJsxNode: s, getComments: i, isCallExpression: r, isMemberExpression: u } = Xe(),
            { locStart: a, locEnd: c } = nt(),
            l = Pt(),
            {
              builders: { line: C, softline: m, group: g, indent: p, align: f, ifBreak: h, dedent: N, breakParent: T },
            } = Le();
          function A(I) {
            let E = [I];
          ...
          function B(I) {
            ...
            for (let y = 0; !D; y++) {
              ...
              (o.type === "NewExpression" && o.callee === d) || (o.type === "TSAsExpression" && o.expression === d)
          ...
          function w(I, E, D) {
            ...
            if (y && (s(d[F[0]]) || s(S) || s(k) || A(W))) {
              ...
              _.push(
                R.type !== d.type || R[x] === d || M ? K : E.useTabs ? N(p(K)) : f(Math.max(0, E.tabWidth - 2), K)
              );
            }
            let U = [...F.map((K) => i(d[K])), i(S), i(k)].flat().some((K) => l(K) && t(E.originalText, a(K), c(K))),
              ne = (K) => (R === $ ? g(K, { shouldBreak: U }) : U ? [K, T] : K),
      ...
      lo = Z({
        "src/language-js/print/block.js"(e, n) {
          ...
          var { printDanglingComments: t } = Qe(),
            ...
            { hasComment: u, CommentCheckFlags: a, isNextLineEmpty: c } = Xe(),
      ...
      Pm = Z({
        "src/language-js/print/typescript.js"(e, n) {
          ...
          var { printDanglingComments: t } = Qe(),
            ...
            T = _m(),
            { locStart: A, locEnd: b } = nt(),
            { printOptionalToken: v, printTypeScriptModifiers: B } = ot(),
            { printTernary: w } = oo(),
            { printFunctionParameters: I, shouldGroupFunctionParameters: E } = wr(),
            ...
            switch (V.type) {
              ...
              case "TSIndexSignature": {
                let Ee = U.getParentNode(),
                  ...
                  le = c([l([a, i([", ", a], U.map(se, "parameters"))]), q, a]);
                return [
                  V.export ? "export " : "",
              ...
              case "TSEnumDeclaration":
                return (
                  ...
                  V.members.length === 0
                    ? K.push(c(["{", t(U, ne), a, "}"]))
                    : K.push(c(["{", l([u, d(U, ne, "members", se), f(ne, "es5") ? "," : ""]), t(U, ne, !0), u, "}"])),
                  K
                );
              case "TSEnumMember":
        ...
        "src/language-js/print/comment.js"(e, n) {
          ...
          function C(p, f) {
            ...
            if (l(h)) {
              if (m(h)) {
                let A = g(h);
                return h.trailing && !t(f.originalText, a(h), { backwards: !0 }) ? [i, A] : A;
              }
              let N = c(h),
...
`);
            return [
              ...
              s(
                i,
                f.map((h, N) => (N === 0 ? h.trimEnd() : " " + (N < f.length - 1 ? h.trim() : h.trimStart())))
              ),
              "*/",
            ];
          }
      ...
      Lm = Z({
        "src/language-js/printer-estree.js"(e, n) {
          ...
          var { printDanglingComments: t } = Qe(),
            { hasNewline: s } = Ge(),
            {
              builders: { join: i, line: r, hardline: u, softline: a, group: c, indent: l },
            ...
            S = Pt(),
            { printHtmlBinding: k, isVueEventBindingExpression: _ } = bm(),
            { printAngular: O } = Tm(),
            ...
            { printArray: q } = zt(),
            { printObject: le } = zn(),
            { printClass: ue, printClassMethod: Q, printClassProperty: de } = Yt(),
            { printProperty: ge } = Kt(),
            {
              printFunction: ve,
            ...
            { printVariableDeclarator: ce, printAssignmentExpression: he } = Xt(),
          ...
          function je(Te, _e, Fe, Ke) {
            ...
            switch (Se.type) {
              ...
              case "File":
                return (
                  Se.program && Se.program.interpreter && Be.push(Fe(["program", "interpreter"])),
                  Be.push(Fe("program")),
                  Be
                );
              case "Program":
              ...
              case "UnaryExpression":
                return (
                  ...
                  A(Se.argument) ? Be.push(c(["(", l([a, Fe("argument")]), a, ")"])) : Be.push(Fe("argument")),
                  Be
                );
              case "UpdateExpression":
              ...
              case "VariableDeclaration": {
                let Ie = Te.map(Fe, "declarations"),
                  Ve = Te.getParentNode(),
                  Ae = Ve.type === "ForStatement" || Ve.type === "ForInStatement" || Ve.type === "ForOfStatement",
              ...
              case "IfStatement": {
                ...
                if ((Be.push(Ve), Se.alternate)) {
                  ...
                  Be.push(Oe ? " " : u),
                    A(Se, b.Dangling) && Be.push(t(Te, _e, !0), Ae ? u : " "),
                    Be.push("else", c(W(Se.alternate, Fe("alternate"), Se.alternate.type === "IfStatement")));
                }
                return Be;
              }
              case "ForStatement": {
                ...
                return !Se.init && !Se.test && !Se.update
                  ? [Ae, c(["for (;;)", Ie])]
                  : [Ae, c(["for (", c([l([a, Fe("init"), ";", r, Fe("test"), ";", r, Fe("update")]), a]), ")", Ie])];
              }
              case "WhileStatement":
              ...
              case "DoWhileStatement": {
                ...
                return (
                  (Be = [c(["do", Ie])]),
                  Se.body.type === "BlockStatement" ? Be.push(" ") : Be.push(u),
                  Be.push("while (", c([l([a, Fe("test")]), a]), ")", ze),
                  Be
                );
              }
              case "DoExpression":
              ...
              case "SwitchCase": {
                Se.test ? Be.push("case ", Fe("test"), ":") : Be.push("default:"),
        ...
        "src/language-js/printer-estree-json.js"(e, n) {
          ...
          function c(l, C) {
            ...
            if (m === "ArrayExpression") {
              for (let [g, p] of l.elements.entries()) p === null && C.elements.splice(g, 0, { type: "NullLiteral" });
              return;
            }
          ...
          var t = bt(),
            ...
            a = [
              t(Fn(), (l) => ({
                ...
                extensions: [...l.extensions.filter((C) => C !== ".jsx"), ".wxs"],
              })),
              t(Fn(), () => ({
                name: "Flow",
                since: "0.0.0",
              ...
              t(Wm(), () => ({ since: "1.13.0", parsers: ["json5"], vscodeLanguageIds: ["json5"] })),
            ],
      ...
      Hm = Z({
        "src/language-css/clean.js"(e, n) {
          ...
          function r(a, c, l) {
            if (
              ...
              a.type === "css-comment" &&
                ...
                (((l.nodes[0] === a || (t(l.nodes[0]) && l.nodes[1] === a)) &&
                  (delete c.text, /^\*\s*@(?:format|prettier)\s*$/.test(a.text))) ||
                  (l.type === "css-root" && s(l.nodes) === a)))
            )
              return null;
            if (
              (a.type === "value-root" && delete c.text,
              (a.type === "media-query" || a.type === "media-query-list" || a.type === "media-feature-expression") &&
                delete c.value,
              a.type === "css-rule" && delete c.params,
              a.type === "selector-combinator" && (c.value = c.value.replace(/\s+/g, " ")),
              a.type === "media-feature" && (c.value = c.value.replace(/ /g, "")),
              ((a.type === "value-word" &&
                ((a.isColor && a.isHex) ||
                  ["initial", "inherit", "unset", "revert"].includes(c.value.replace().toLowerCase()))) ||
              ...
              (a.type === "css-atrule" || a.type === "css-import") && (c.name = c.name.toLowerCase()),
              a.type === "value-number" && (c.unit = c.unit.toLowerCase()),
              (a.type === "media-feature" ||
              ...
              a.type === "selector-attribute" &&
                ...
                c.namespace &&
                  ...
                  ((c.namespace = c.namespace.trim()), c.namespace.length === 0 && (c.namespace = !0)),
                c.value && ((c.value = c.value.trim().replace(/^["']|["']$/g, "")), delete c.quoted)),
              (a.type === "media-value" ||
                a.type === "media-type" ||
                a.type === "value-number" ||
                a.type === "selector-root-invalid" ||
                ...
                a.type === "selector-tag") &&
                c.value &&
                (c.value = c.value.replace(/([\d+.Ee-]+)([A-Za-z]*)/g, (C, m, g) => {
                  let p = Number(m);
            ...
            if (
              (a.type === "css-atrule" && a.name.toLowerCase() === "supports" && delete c.value,
              ...
              C !== -1 &&
                ((c.groups[C].unit = ""),
                c.groups.splice(C + 1, 0, { type: "value-word", value: "...", isColor: !1, isHex: !1 }));
            }
          }
      ...
      Xn = Z({
        "src/utils/front-matter/print.js"(e, n) {
          ...
          function i(r, u) {
            if (r.lang === "yaml") {
              let a = r.value.trim(),
                c = a ? u(a, { parser: "yaml" }, { stripTrailingHardline: !0 }) : "";
      ...
      po = Z({
        "src/utils/front-matter/parse.js"(e, n) {
          ...
          function s(i) {
            ...
            let { startDelimiter: u, language: a, value: c = "", endDelimiter: l } = r.groups,
              C = a.trim() || "yaml";
            if ((u === "+++" && (C = "toml"), C !== "yaml" && u !== l)) return { content: i };
            let [m] = r;
            return {
              frontMatter: {
                type: "front-matter",
      ...
      Um = Z({
        "src/language-css/utils/index.js"(e, n) {
          ...
          function a(q, le) {
            ...
            return (
              ue && ue.name && ue.name.toLowerCase().endsWith("keyframes") && ["from", "to"].includes(le.toLowerCase())
            );
          }
          function c(q) {
            return q.includes("$") ||
        ...
        "src/language-css/loc.js"(e, n) {
          ...
          function a(p, f) {
            ...
            for (let h in p) {
              ...
              h === "source" ||
                !N ||
                typeof N != "object" ||
                (N.type === "value-root" || N.type === "value-unknown" ? c(N, l(p), N.text || N.value) : a(N, f));
            }
          }
          function c(p, f, h) {
          ...
          function l(p) {
            ...
            return (
              ...
              p.type !== "css-atrule" && p.raws && typeof p.raws.between == "string" && (f += p.raws.between.length),
              f
            );
          }
          function C(p) {
...
` ||
        ...
        "src/language-css/printer-postcss.js"(e, n) {
          ...
          function Ue(Ae, Oe, Pe) {
            ...
            switch (ie.type) {
                ...
                return [
                  ...
                  ie.nodes
                    ? [
                        ...
                        "{",
                        ie.nodes.length > 0 ? h([m, tt(Ae, Oe, Pe)]) : "",
                        m,
                        "}",
                        R(ie) ? ";" : "",
                      ]
                ...
                if (j(Oe)) {
                  ...
                  if (ie.variable)
                    return [
                      ...
                      ie.nodes ? ["{", h([ie.nodes.length > 0 ? g : "", tt(Ae, Oe, Pe)]), g, "}"] : "",
                      qe ? "" : ";",
                    ];
                }
                return [
                  ...
                  ie.value ? p([" ", Pe("value"), O(ie) ? (oe(ie) ? " " : C) : ""]) : ie.name === "else" ? " " : "",
                  ie.nodes
                    ? [
                        O(ie)
                          ? ""
                          ...
                          : " ",
                        "{",
                        h([ie.nodes.length > 0 ? g : "", tt(Ae, Oe, Pe)]),
                        g,
                        "}",
                      ]
                    : qe
              ...
              case "selector-root":
                return p([
                  x(Ae, "custom-selector") ? [E(Ae, "css-atrule").customSelector, C] : "",
                  l([",", x(Ae, ["extend", "custom-selector", "nest"]) ? C : m], Ae.map(Pe, "nodes")),
                ]);
              ...
              case "value-comma_group": {
                ...
                for (let ut = 0; ut < ie.groups.length; ++ut) {
                  ...
                  if (
                    ...
                    continue;
                  let ho = Re.type === "value-string" && Re.value.startsWith("#{"),
                  ...
                  if (
                    !(
                      ...
                      !y(Ae, "calc") &&
                      !Eo &&
                      ((G(He) && !eu) || (G(Re) && !tu) || (re(He) && !eu) || (re(Re) && !tu) || $(He) || $(Re)) &&
                      (K(He) || (Qn && (!et || (et && W(et)))))
                    )
                  ) {
                    if (ve(Re)) {
              ...
              case "value-paren_group": {
                ...
                if (!ie.open) {
                  let ke = Ae.map(Pe, "groups"),
                    We = [];
                  for (let $e = 0; $e < ke.length; $e++) $e !== 0 && We.push([",", C]), We.push(ke[$e]);
                  return p(h(f(We)));
                }
                let qe = ge(Ae),
                  Je = t(ie.groups),
              ...
              Ae.each((Me, qe, Je) => {
                ...
                qe !== Je.length - 1 &&
                  ((Je[qe + 1].type === "css-comment" &&
                    ...
                    !u(Je[qe])) ||
                  (Je[qe + 1].type === "css-atrule" && Je[qe + 1].name === "else" && Je[qe].type !== "css-comment")
                    ? ie.push(" ")
          ...
          var Te = /(["'])(?:(?!\1)[^\\]|\\.)*\1/gs,
            ...
            Ke = /[$@]?[A-Z_a-z\u0080-\uFFFF][\w\u0080-\uFFFF-]*/g,
            Se = new RegExp(
              Te.source + "|(".concat(Ke.source, ")?(").concat(_e.source, ")(").concat(Fe.source, ")?"),
              "g"
            );
          function ze(Ae, Oe) {
        ...
        "src/language-css/index.js"(e, n) {
          ...
          var t = bt(),
            ...
            u = [
              ...
              t(ud(), () => ({ since: "1.4.0", parsers: ["css"], vscodeLanguageIds: ["postcss"] })),
              t(sd(), () => ({ since: "1.4.0", parsers: ["less"], vscodeLanguageIds: ["less"] })),
              t(ad(), () => ({ since: "1.4.0", parsers: ["scss"], vscodeLanguageIds: ["scss"] })),
            ],
            a = { postcss: s };
      ...
      pd = Z({
        "src/language-handlebars/utils.js"(e, n) {
          ...
          function T(b) {
            return (
              C(b, ["MustacheCommentStatement"]) && typeof b.value == "string" && b.value.trim() === "prettier-ignore"
            );
          }
          function A(b) {
            let v = b.getValue(),
            ...
            switch (Y.type) {
              ...
              case "BlockStatement": {
                ...
                return z &&
                  ...
                  : [W(J, X), i([K(J, X, ye), Ee(J, X, ye), ne(J, X, ye)])];
              }
              ...
              case "TextNode": {
                  ...
                  if (j === "class") {
                    ...
                    return (
                      E(J, ["ConcatStatement"]) &&
                        ...
                        w(J, ["MustacheStatement"]) && /\s$/.test(z) && Se !== "" && (Be = !0)),
                      [ze ? l : "", Se, Be ? l : ""]
                    );
                  }
                  return g(z);
                ...
                Ne && tt
                  ...
                  : (w(J, ["BlockStatement", "ElementNode"]) && (_e = Math.max(_e, 1)),
                    D(J, ["BlockStatement", "ElementNode"]) && (Te = Math.max(Te, 1)));
                let Fe = "",
                  Ke = "";
                return (
      ...
      dd = Z({
        "src/language-handlebars/index.js"(e, n) {
          ...
          var t = bt(),
            s = fd(),
            i = Dd(),
            r = [t(md(), () => ({ since: "2.3.0", parsers: ["glimmer"], vscodeLanguageIds: ["handlebars"] }))],
            u = { glimmer: s };
...
` + i
      ...
      hd = Z({
        "src/language-graphql/printer-graphql.js"(e, n) {
          ...
          ae();
          var {
              builders: { join: t, hardline: s, line: i, softline: r, group: u, indent: a, ifBreak: c },
            } = Le(),
            ...
            switch (D.kind) {
              ...
              case "OperationDefinition": {
                ...
                return [
                  ...
                  C(D.variableDefinitions)
                    ? u(["(", a([r, t([c("", ", "), r], w.map(E, "variableDefinitions"))]), r, ")"])
                    : "",
                  h(w, E, D),
                  D.selectionSet ? (!d && !y ? "" : " ") : "",
                  E("selectionSet"),
              ...
              case "Field":
                return u([
                  D.alias ? [E("alias"), ": "] : "",
                  E("name"),
                  D.arguments.length > 0 ? u(["(", a([r, t([c("", ", "), r], N(w, I, E, "arguments"))]), r, ")"]) : "",
                  h(w, E, D),
                  D.selectionSet ? " " : "",
                  E("selectionSet"),
                ]);
...
`)
              ...
              case "ObjectTypeDefinition":
                return [
                  ...
                  h(w, E, D),
                  D.fields.length > 0 ? [" {", a([s, t(s, N(w, I, E, "fields"))]), s, "}"] : "",
                ];
              ...
              case "EnumTypeDefinition":
                return [
                  ...
                  E("name"),
                  h(w, E, D),
                  D.values.length > 0 ? [" {", a([s, t(s, N(w, I, E, "values"))]), s, "}"] : "",
                ];
              ...
              case "SchemaDefinition":
                return [
                  ...
                  h(w, E, D),
                  " {",
                  D.operationTypes.length > 0 ? a([s, t(s, N(w, I, E, "operationTypes"))]) : "",
                  s,
                  "}",
                ];
              ...
              case "UnionTypeDefinition":
                return u([
                  ...
                  u([
                    ...
                    E("name"),
                    h(w, E, D),
                    D.types.length > 0 ? [" =", c("", " "), a([c([i, "  "]), t([i, "| "], w.map(E, "types"))])] : "",
                  ]),
                ]);
      ...
      Fd = Z({
        "src/language-graphql/index.js"(e, n) {
          ...
          var t = bt(),
            ...
            i = Cd(),
            r = Ed(),
            u = [t(vd(), () => ({ since: "1.5.0", parsers: ["graphql"], vscodeLanguageIds: ["graphql"] }))],
            a = { graphql: s };
          n.exports = { languages: u, options: i, printers: a, parsers: r };
        },
      }),
      ...
      Kn = Z({
        "src/language-markdown/utils.js"(e, n) {
          ...
          var { getLast: t } = Ge(),
            ...
            { cjkPattern: r, kPattern: u, punctuationPattern: a } = Ad(),
            c = [
              "liquidNode",
              "inlineCode",
              "emphasis",
...
`
              ...
              for (let [F, S] of x.entries())
                if (!((F === 0 || F === x.length - 1) && S === "")) {
                  ...
                  d(
                    m.test(S)
                      ? { type: "word", value: S, kind: I, hasLeadingPunctuation: !0, hasTrailingPunctuation: !0 }
                      : {
                          type: "word",
                          value: S,
                          kind: C.test(S) ? w : B,
            ...
            function d(y) {
              ...
              o &&
                o.type === "word" &&
                ((o.kind === v && y.kind === B && !o.hasTrailingPunctuation) ||
                (o.kind === B && y.kind === v && !y.hasLeadingPunctuation)
          ...
          function l(C, m, g, p) {
            ...
            if (f.type === "code" && f.lang !== null) {
              ...
              if (h) {
                ...
                let b = g(c(f, p.originalText), A, { stripTrailingHardline: !0 });
            ...
            switch (f.type) {
              case "front-matter":
                return a(f, g);
              case "importExport":
                return [g(f.value, { parser: "babel" }, { stripTrailingHardline: !0 }), i];
              case "jsx":
                return g(
                  "<$>".concat(f.value, "</$>"),
...
`
      ...
      xd = Z({
        "src/language-markdown/print-preprocess.js"(e, n) {
          ...
          ae();
          var t = st(),
            { getOrderedListItemInfo: s, mapAst: i, splitText: r } = Kn(),
            u = /^.$/su;
          function a(T, A) {
            return (
              (T = C(T, A)),
            ...
            if (
              ...
              u.type === "text" ||
                ...
                c &&
                  c.type === "root" &&
                  c.children.length > 0 &&
                  (c.children[0] === u || (t(c.children[0]) && c.children[1] === u)) &&
                  u.type === "html" &&
                  s(u.value)))
            )
              return null;
              ...
              case "word": {
                let he = ce.value
                    ...
                    .replace(
                      ...
                      (X, Y, te, z, j) => (te ? "".concat(Y).concat(te) : "".concat(z).concat(j)).replace(/_/g, "\\_")
                    ),
              ...
              case "footnoteDefinition": {
                ...
                return [
                  ...
                  J
                    ? K(fe, pe, me)
                    : A([
                        N(" ".repeat(4), K(fe, pe, me, { processor: (ye, X) => (X === 0 ? A([p, me()]) : me()) })),
          ...
          function oe(fe, pe, me) {
            ...
            for (let [ye, X] of J.entries())
              switch (q(X)) {
                ...
                case "end":
                  he !== null &&
                    (ce.push({ start: he, end: { index: ye, offset: X.position.start.offset } }), (he = null));
                  break;
                default:
                  break;
              }
            ...
            return (
              fe.each((te, z) => {
                ...
                if (Ce !== !1) {
                  ...
                  le(j, Ne) &&
                    (X.push(g), (Y && M.has(Y.type)) || ((ue(j, Ne) || Q(j, Ne)) && X.push(g)), Q(j, Ne) && X.push(g)),
                    X.push(Ce),
                    (Y = j);
                }
              }, "children"),
      ...
      Ot = Z({
        "src/language-html/utils/index.js"(e, n) {
          ...
          var { inferParserByLanguage: t, isFrontMatterNode: s } = Ge(),
            ...
            { CSS_DISPLAY_TAGS: l, CSS_DISPLAY_DEFAULT: C, CSS_WHITE_SPACE_TAGS: m, CSS_WHITE_SPACE_DEFAULT: g } = Pd(),
            p = Id(),
            f = new Set([
              "	",
              `
            ...
            switch (Ce.htmlWhitespaceSensitivity) {
              ...
              default:
                return Ce.parser === "vue" && j.parent && j.parent.type === "root"
                  ? "block"
                  : (j.type === "element" && (!j.namespace || Ne || p(j)) && l[j.name]) || C;
            }
          }
          function we(j) {
...
` && ++N == m
          ...
          var a = class {
            ...
            contextualMessage() {
              ...
              return C
                ? "".concat(this.msg, ' ("').concat(C.before, "[").concat(u[this.level], " ->]").concat(C.after, '")')
                : this.msg;
            }
            toString() {
          ...
          function c(C, m) {
            let g = t.identifierModuleUrl(m),
              p =
                g != null
                  ? "in ".concat(C, " ").concat(t.identifierName(m), " in ").concat(g)
...
`
          ...
          function N(d) {
            let y = (o) =>
              ...
              o.prev.sourceSpan.end.offset === o.startSourceSpan.start.offset &&
              o.firstChild &&
              o.firstChild.type === "ieConditionalEndComment" &&
              o.firstChild.sourceSpan.start.offset === o.startSourceSpan.end.offset;
            d.walk((o) => {
              if (o.children)
            ...
            d.walk((o) => {
              if (o.children)
                for (let x = 0; x < o.children.length; x++) {
                  ...
                  let S = F.prev,
                    k = F.next;
                  (S.value += "<".concat(F.rawName, ">") + F.firstChild.value + "</".concat(F.rawName, ">") + k.value),
              ...
              if (!!u(x))
                for (let F of x.children) {
                  ...
                  for (let O = 0; O < _.length; O++, S = k) {
                    ...
                    if (O % 2 === 0) {
                      (k = S.moveBy(R.length)),
                        R.length > 0 && x.insertChildBefore(F, { type: "text", value: R, sourceSpan: new t(S, k) });
                      continue;
                    }
                    (k = S.moveBy(R.length + 4)),
                      x.insertChildBefore(F, {
                        ...
                        children:
                          R.length === 0
                            ? []
                            : [{ type: "text", value: R, sourceSpan: new t(S.moveBy(2), k.moveBy(-2)) }],
                      });
                  }
                  x.removeChild(F);
                }
          ...
          function B(d) {
            d.walk((y) => {
              ...
              if (
                y.children.length === 0 ||
                (y.children.length === 1 && y.children[0].type === "text" && s(y.children[0].value).length === 0)
              ) {
              ...
              if (!o)
                for (let F = 0; F < y.children.length; F++) {
                  ...
                  let { leadingWhitespace: k, text: _, trailingWhitespace: O } = i(S.value),
                    R = S.prev,
                    M = S.next;
                  _
                    ? ((S.value = _),
                      (S.sourceSpan = new t(S.sourceSpan.start.moveBy(k.length), S.sourceSpan.end.moveBy(-O.length))),
            ...
            d.walk((o) => {
              o.type === "element" &&
                (o.hasHtmComponentClosingTag =
                  o.endSourceSpan &&
                  /^<\s*\/\s*\/\s*>$/.test(
                    y.originalText.slice(o.endSourceSpan.start.offset, o.endSourceSpan.end.offset)
                  ));
            });
          }
          function E(d, y) {
                ...
                for (let F = 0; F < x.length; F++) {
                  ...
                  (S.isLeadingSpaceSensitive =
                    ...
                    (S.isTrailingSpaceSensitive =
                      (F === x.length - 1 || S.next.isLeadingSpaceSensitive) && S.isTrailingSpaceSensitive);
                }
              }
            });
          }
      ...
      Qt = Z({
        "src/language-html/print/tag.js"(e, n) {
          ...
          var t = Ut(),
            { isNonEmptyArray: s } = Ge(),
            {
              builders: { indent: i, join: r, line: u, softline: a, hardline: c },
          ...
          function D(P) {
            return (
              P.prev && P.prev.type !== "docType" && !g(P.prev) && P.isLeadingSpaceSensitive && !P.hasLeadingSpaces
            );
          }
          function d(P) {
            return (
          ...
          function S(P, G, re) {
            ...
            let W = $.prev && $.prev.type === "comment" && x($.prev.value),
              ...
              V = [i([ne ? " " : u, r(se, U)])];
            return (
              ($.firstChild && F($.firstChild)) || ($.isSelfClosing && d($.parent)) || ne
...
` ||
                  ...
                  for (y = 0; y < h.length; y++)
                    (x = h[y]),
                      ...
                      g.test(S) && F === "w"
                        ? ((E || D) && (I = !0), k === 0 ? (I = !0) : (E = k))
                        : p.test(S) && F === "x"
                        ? ((E || D || d) && (I = !0), _ < 0 ? (I = !0) : (D = _))
                        : g.test(S) && F === "h"
                        ? ((d || D) && (I = !0), k === 0 ? (I = !0) : (d = k))
                        : (I = !0);
                  I
                    ? i && i.error && i.error("Invalid srcset descriptor found in '" + t + "' at '" + x + "'.")
                    : ((o.url = f), E && (o.w = E), D && (o.d = D), d && (o.h = d), v.push(o));
                }
              };
            });
        },
        ...
        "src/language-html/syntax-attribute.js"(e, n) {
          ...
          function u(c) {
            ...
            let p = C ? "w" : m ? "h" : "d",
              ...
              A = l.map((B) => B[p]).map((B) => (B ? B.toString() : "")),
              b = A.map((B) => {
                let w = B.indexOf(".");
      ...
      $d = Z({
        "src/language-html/syntax-vue.js"(e, n) {
          ...
          function s(a, c) {
            ...
            return [
              t(c("function _(".concat(l, ") {}"), { parser: "babel", __isVueForBindingLeft: !0 })),
              " ",
              C,
              " ",
              c(m, { parser: "__js_expression" }, { stripTrailingHardline: !0 }),
            ];
          }
          function i(a) {
            let c = /(.*?)\s+(in|of)\s+(.*)/s,
            ...
            let p = m[1].trim().replace(C, ""),
              f = p.match(l);
            f
              ? ((g.alias = p.replace(l, "")), (g.iterator1 = f[1].trim()), f[2] && (g.iterator2 = f[2].trim()))
              : (g.alias = p);
          ...
          function r(a, c) {
            return c("function _(".concat(a, ") {}"), { parser: "babel", __isVueBindings: !0 });
          }
          function u(a) {
      ...
      mo = Z({
        "src/language-html/get-node-content.js"(e, n) {
          ...
          function c(l, C) {
            ...
            return (
              l.lastChild && t(l.lastChild) ? (g += s(l, C).length) : i(l) && (g -= r(l.lastChild, C).length),
      ...
      Hd = Z({
        "src/language-html/embed.js"(e, n) {
          ...
          ae();
          var {
              builders: { breakParent: t, group: s, hardline: i, indent: r, line: u, fill: a, softline: c },
            ...
            { printVueFor: b, printVueBindings: v, isVueEventBindingExpression: B } = $d(),
            {
              isScriptLikeTag: w,
              isVueNonHtmlBlock: I,
              inferScriptParser: E,
              ...
              if (Ee.test(q)) {
                ...
                for (let [ue, Q] of q.split(Ee).entries())
                  if (ue % 2 === 0) le.push(C(Q));
                    ...
                    try {
                      le.push(
                        s(["{{", r([u, ne(Q, { parser: "__ng_interpolation", __isInHtmlInterpolation: !0 })]), u, "}}"])
                      );
                    } catch {
                      le.push("{{", C(Q), "}}");
                    }
                ...
                if (!P.isSelfClosing && I(P, H)) {
                  ...
                  return (
                    $ ||
                      ...
                      ($ = W === "")),
                    [h(P, H), s(N(O, H, R)), $ ? "" : i, W, $ ? "" : i, g(P, H), p(P, H)]
                  );
                }
                break;
              }
              case "text": {
                if (w(P.parent)) {
                  ...
                  if (G) {
                    ...
                    if (H.parser === "html" && G === "babel") {
                      let W = "script",
                        { attrMap: ee } = P.parent;
                      ee &&
                        (ee.type === "module" || (ee.type === "text/babel" && ee["data-type"] === "module")) &&
                        (W = "module"),
                        ($.__babelSourceType = W);
                    }
                    return [t, h(P, H), M(re, $, { stripTrailingHardline: !0 }), p(P, H)];
                  }
                  ...
                  return (
                    ...
                    [r([u, M(P.value, G, { stripTrailingHardline: !0 })]), P.parent.next && f(P.parent.next) ? " " : u]
                  );
                }
                break;
              }
      ...
      go = Z({
        "src/language-html/print/children.js"(e, n) {
          ...
          ae();
          var {
              builders: { breakParent: t, group: s, ifBreak: i, line: r, softline: u, hardline: a },
              utils: { replaceTextEndOfLine: c },
            } = Le(),
          ...
          function E(d, y) {
            return p(d) && p(y)
              ? d.isTrailingSpaceSensitive
                ...
                ? a
                : u
              : (T(d) && (f(y) || y.firstChild || y.isSelfClosing || (y.type === "element" && y.attrs.length > 0))) ||
                (d.type === "element" && d.isSelfClosing && b(y))
              ? ""
              : !y.isLeadingSpaceSensitive ||
                h(y) ||
                (b(y) && d.lastChild && w(d.lastChild) && d.lastChild.lastChild && w(d.lastChild.lastChild))
              ? a
              : y.hasLeadingSpaces
              ? r
              : u;
      ...
      Gd = Z({
        "src/language-html/print/element.js"(e, n) {
          ...
          function E(D, d, y) {
            let o = D.getValue();
            if (g(o, d)) return [T(o, d), i(A(D, d, y)), ...C(m(o, d)), ...v(o, d), b(o, d)];
            let x =
                o.children.length === 1 &&
              ...
              k = (R) =>
                x
                  ? u(R, { groupId: F })
                  : (p(o) || f(o, d)) && o.parent.type === "root" && d.parser === "vue" && !d.vueIndentScriptAndStyle
                  ? R
                  : a(R),
              _ = () =>
                x
                  ? r(l, "", { groupId: F })
                  : o.firstChild.hasLeadingSpaces && o.firstChild.isLeadingSpaceSensitive
                  ? c
                  : o.firstChild.type === "text" && o.isWhitespaceSensitive && o.isIndentationSensitive
                  ? s(l)
                  : l,
              O = () =>
                (o.next ? B(o.next) : w(o.parent))
                  ? o.lastChild.hasTrailingSpaces && o.lastChild.isTrailingSpaceSensitive
                    ? " "
                    : ""
                  : x
                  ? r(l, "", { groupId: F })
                  ...
                  : (o.lastChild.type === "comment" ||
                      (o.lastChild.type === "text" && o.isWhitespaceSensitive && o.isIndentationSensitive)) &&
                    new RegExp(
                      "\\n[\\t ]{".concat(d.tabWidth * h(D, (M) => M.parent && M.parent.type !== "root"), "}$")
                    ).test(o.lastChild.value)
                  ? ""
                  : l;
            return o.children.length === 0
              ? S(o.hasDanglingSpaces && o.isDanglingSpaceSensitive ? c : "")
      ...
      Jd = Z({
        "src/language-html/printer-html.js"(e, n) {
          ...
          ae();
          var {
              builders: { fill: t, group: s, hardline: i, literalline: r },
              utils: { cleanDoc: u, getDocParts: a, isConcat: c, replaceTextEndOfLine: l },
            } = Le(),
            C = _d(),
            { countChars: m, unescapeQuoteEntities: g, getTextValueParts: p } = Ot(),
            f = Md(),
            { insertPragma: h } = Rd(),
        ...
        "src/language-html/index.js"(e, n) {
          ...
          var t = bt(),
            ...
            u = [
              ...
              t(Xd(), () => ({ since: "1.10.0", parsers: ["vue"], vscodeLanguageIds: ["vue"] })),
            ],
            a = { html: s };
...
` && d++,
          ...
          function v(E) {
            ...
            for (let y of E.split(/( +)/))
              y !== " " ? (d === " " ? D.push(y) : D.push((D.pop() || "") + y)) : d === void 0 && D.unshift(""),
                (d = y);
            return (
              d === " " && D.push((D.pop() || "") + " "),
...
`
            ...
            return d.proseWrap === "preserve"
              ...
              : y
                  ...
                  .reduce(
                    (o, x, F) =>
                      F !== 0 && y[F - 1].length > 0 && x.length > 0 && !(E === "quoteDouble" && t(t(o)).endsWith("\\"))
                        ? [...o.slice(0, -1), [...t(o), ...x]]
                        : [...o, x],
                    []
                  )
                  .map((o) => (d.proseWrap === "never" ? [o.join(" ")] : o));
          }
          function w(E, D) {
            let { parentIndent: d, isLastDescendant: y, options: o } = D,
              x =
                E.position.start.line === E.position.end.line
                  ? ""
                  : o.originalText.slice(E.position.start.offset, E.position.end.offset).match(/^[^\n]*\n(.*)$/s)[1],
              F;
            if (E.indent === null) {
...
`
            ...
            return k(
              S.map((_) => (_.length === 0 ? [] : v(_)))
                .reduce(
                  (_, O, R) =>
                    R !== 0 && S[R - 1].length > 0 && O.length > 0 && !/^\s/.test(O[0]) && !/^\s|\s$/.test(t(_))
                      ? [..._.slice(0, -1), [...t(_), ...O]]
                      : [..._, O],
                  []
                )
                .map((_) =>
                  _.reduce(
                    (O, R) => (O.length > 0 && /\s$/.test(t(O)) ? [...O.slice(0, -1), t(O) + " " + R] : [...O, R]),
                    []
                  )
                )
                .map((_) => (o.proseWrap === "never" ? [_.join(" ")] : _))
            );
            function k(_) {
        ...
        "src/language-yaml/print/misc.js"(e, n) {
          ...
          function c(m, g) {
            let p = m.getValue(),
              ...
              h;
            return (
              a.has(f) ? (h = a.get(f)) : ((h = new Set()), a.set(f, h)),
              !h.has(p.position.end.line) && (h.add(p.position.end.line), r(p, g) && !l(m.getParentNode())) ? t : ""
            );
          }
          function l(m) {
      ...
      tg = Z({
        "src/language-yaml/print/flow-mapping-sequence.js"(e, n) {
          ...
          ae();
          var {
              builders: { ifBreak: t, line: s, softline: i, hardline: r, join: u },
            } = Le(),
      ...
      rg = Z({
        "src/language-yaml/print/mapping-item.js"(e, n) {
          ...
          ae();
          var {
              builders: { conditionalGroup: t, group: s, hardline: i, ifBreak: r, join: u, line: a },
            } = Le(),
            {
          ...
          function N(v, B, w, I, E) {
            ...
            let x = I("key"),
              F = A(v) ? " " : "";
            if (o)
              return v.type === "flowMappingItem" && B.type === "flowMapping"
                ? x
                : v.type === "mappingItem" &&
                  T(D.content, E) &&
                  !C(D.content) &&
            ...
            if (c(d) || !f(D.content))
              return [
                ...
                u(
                  "",
                  w.map(I, "value", "leadingComments").map((H) => [H, i])
                ),
                ": ",
                h(2, S),
              ];
            ...
            let k = Symbol("mappingKey"),
              ...
              R = [F, ":"];
            c(d.content) ||
            (m(d) && d.content && !g(d.content, ["mapping", "sequence"])) ||
            (B.type === "mapping" && C(D.content) && f(d.content)) ||
            (g(d.content, ["mapping", "sequence"]) && d.content.tag === null && d.content.anchor === null)
              ? R.push(i)
              : d.content && R.push(a),
              R.push(S);
            let M = h(E.tabWidth, R);
            return T(D.content, E) && !c(D.content) && !l(D.content) && !m(D)
              ? t([[x, M]])
              : t([[_, r(O, M, { groupId: k })]]);
          }
          function T(v, B) {
        ...
        "src/language-yaml/print/block.js"(e, n) {
          ...
          function T(A, b, v) {
            ...
            B.indent !== null && E.push(B.indent.toString()),
              B.chomping !== "clip" && E.push(B.chomping === "keep" ? "+" : "-"),
              p(B) && E.push(" ", b("indicatorComment"));
            let D = g(B, { parentIndent: w, isLastDescendant: I, options: v }),
              d = [];
            for (let [y, o] of D.entries())
              y === 0 && d.push(r),
                d.push(i(C(u(a, o)))),
                y !== D.length - 1
                  ...
                  : B.chomping === "keep" && I && d.push(s(o.length === 0 ? r : c));
      ...
      ug = Z({
        "src/language-yaml/printer-yaml.js"(e, n) {
          ...
          var {
            ...
            y = eg(),
            { alignWithSpaces: o, printNextEmptyLine: x, shouldPrintEndComments: F } = kr(),
          ...
          function R(W, ee, U) {
            ...
            return (
              I(W)
                ? se.push(m(ee.originalText.slice(ne.position.start.offset, ne.position.end.offset).trimEnd(), l))
              ...
              F(ne) &&
                se.push(
                  o(ne.type === "sequenceItem" ? 2 : 0, [
                    ...
                    u(
                      r,
                      W.map((q) => [g(ee.originalText, q.getValue(), h) ? r : "", U()], "endComments")
                    ),
                  ])
                ),
              se.push(K),
          ...
          function M(W, ee, U, ne, se) {
            switch (W.type) {
              case "root": {
                ...
                U.each((Ee, q) => {
                  ...
                  q !== 0 && oe.push(r),
                    oe.push(se()),
                    P(le, ue)
                      ? (oe.push(r, "..."), B(le) && oe.push(" ", se("trailingComment")))
              ...
              case "document": {
                ...
                return (
                  G(W, V, ee, ne) === "head" &&
                    ...
                    B(W.head) ? oe.push(["---", " ", se(["head", "trailingComment"])]) : oe.push("---")),
                  H(W) && oe.push(se("body")),
                  u(r, oe)
                );
              }
              ...
              case "quoteSingle": {
                ...
                if (K.includes(V)) return [oe, re(W.type, W.type === "quoteSingle" ? K.replace(/''/g, V) : K, ne), oe];
          ...
          function G(W, ee, U, ne) {
            return (U.children[0] === W && /---(?:\s|$)/.test(ne.originalText.slice(h(W), h(W) + 4))) ||
          ...
          var t = bt(),
            ...
            u = [
              t(ig(), (a) => ({
                ...
                filenames: [...a.filenames.filter((c) => c !== "yarn.lock"), ".prettierrc", ".stylelintrc"],
              })),
            ];
      ...
      return function () {
        ...
        return (
          (s[n] = Object.assign(
            Object.assign({}, r),
            {},
            { plugins: [...Dg, ...(Array.isArray(u) ? u : Object.values(u))] }
          )),
          e(...s)
        );
      };
