    ...
    module2.exports = TO_STRING_TAG_SUPPORT
      ...
      : function (it) {
          ...
          return it === void 0
            ...
            : it === null
            ? "Null"
            : typeof (tag = tryGet((O = Object2(it)), TO_STRING_TAG)) == "string"
            ? tag
            : CORRECT_ARGUMENTS
            ? classofRaw(O)
      ...
      while (sourceIndex < sourceLen) {
        if (sourceIndex in source) {
          ...
          if (depth > 0 && isArray(element)) {
            ...
            if (targetIndex >= 9007199254740991) throw TypeError2("Exceed the acceptable array length");
  ...
  "node_modules/core-js/internals/array-species-constructor.js"(exports2, module2) {
    ...
    module2.exports = function (originalArray) {
      ...
      if (isArray(originalArray)) {
        ...
        if (isConstructor(C) && (C === Array2 || isArray(C.prototype))) C = void 0;
        else if (isObject(C)) {
          C = C[SPECIES];
          if (C === null) C = void 0;
        }
...
var require_logger = __commonJS2({
  "src/cli/logger.js"(exports2, module2) {
    ...
    var { default: stripAnsi } = require_strip_ansi();
    var { default: chalk } = require_chalk();
...
var require_get_context_options = __commonJS2({
  "src/cli/options/get-context-options.js"(exports2, module2) {
    ...
    var { normalizeDetailedOptionMap, createDetailedOptionMap } = require_option_map();
    function getContextOptions(plugins, pluginSearchDirs) {
      const { options: supportOptions, languages } = prettier2.getSupportInfo({
        showDeprecated: true,
        showUnreleased: true,
        showInternal: true,
        plugins,
      ...
      const detailedOptionMap = normalizeDetailedOptionMap(
        Object.assign(Object.assign({}, createDetailedOptionMap(supportOptions)), constant.options)
      );
      ...
      const apiDefaultOptions = Object.assign(
        ...
        Object.fromEntries(
          supportOptions.filter(({ deprecated }) => !deprecated).map((option) => [option.name, option.default])
        )
      );
      return {
        supportOptions,
...
var require_create_minimist_options = __commonJS2({
  "src/cli/options/create-minimist-options.js"(exports2, module2) {
    ...
    module2.exports = function createMinimistOptions(detailedOptions) {
      const [boolean, string] = partition(detailedOptions, ({ type }) => type === "boolean").map((detailedOptions2) =>
        detailedOptions2.flatMap(({ name, alias }) => (alias ? [name, alias] : [name]))
      );
      const defaults = Object.fromEntries(
        detailedOptions
          .filter(
            (option) =>
              !option.deprecated &&
              (!option.forwardToApi || option.name === "plugin" || option.name === "plugin-search-dir") &&
...
var require_normalize_cli_options = __commonJS2({
  "src/cli/options/normalize-cli-options.js"(exports2, module2) {
    "use strict";
    var { default: chalk } = require_chalk();
    var { default: leven } = require_leven();
    var { optionsNormalizer } = require_prettier_internal();
    function normalizeCliOptions(options, optionInfos, opts) {
      return optionsNormalizer.normalizeCliOptions(
        options,
        optionInfos,
        Object.assign(
          {
...
var require_context = __commonJS2({
  "src/cli/context.js"(exports2, module2) {
    ...
    var getContextOptions = require_get_context_options();
    var { parseArgv, parseArgvWithoutPlugins: parseArgvWithoutPlugins2 } = require_parse_cli_arguments();
    var Context2 = class {
      constructor({ rawArguments, logger }) {
        this.rawArguments = rawArguments;
        this.logger = logger;
        this.stack = [];
        const { plugins, pluginSearchDirs } = parseArgvWithoutPlugins2(rawArguments, logger, [
          "plugin",
          "plugin-search-dir",
        ]);
...
var require_is_tty = __commonJS2({
  "src/cli/is-tty.js"(exports2, module2) {
    "use strict";
    var { isCI } = require("./third-party.js");
...
var require_format = __commonJS2({
  "src/cli/format.js"(exports2, module2) {
    ...
    var { default: chalk } = require_chalk();
    var prettier2 = require("./index.js");
    var { getStdin } = require("./third-party.js");
    var { createIgnorer, errors } = require_prettier_internal();
    var { expandPatterns, fixWindowsSlashes } = require_expand_patterns();
    ...
    function format(context, input, opt) {
      ...
      if (context.argv.debugPrintAst) {
        const { ast } = prettier2.__debug.parse(input, opt);
        return {
      ...
      if (context.argv.debugBenchmark) {
        ...
        suite
          ...
          .on("cycle", (event) => {
            ...
            context.logger.debug(
              "'--debug-benchmark' measurements for formatWithCursor: " + JSON.stringify(results, null, 2)
            );
          })
          .run({
            async: false,
    ...
    async function formatFiles2(context) {
      ...
      for await (const pathOrError of expandPatterns(context)) {
        ...
        if (
          fileIgnored &&
          (context.argv.debugCheck || context.argv.write || context.argv.check || context.argv.listDifferent)
        ) {
          continue;
        }
...
var require_file_info = __commonJS2({
  "src/cli/file-info.js"(exports2, module2) {
    ...
    var prettier2 = require("./index.js");
    var { printToScreen: printToScreen2 } = require_utils5();
    async function logFileInfoOrDie2(context) {
      const { fileInfo: file, ignorePath, withNodeModules, plugins, pluginSearchDirs, config } = context.argv;
      ...
      printToScreen2(
        prettier2.format(stringify2(fileInfo), {
          parser: "json",
        })
      );
    }
