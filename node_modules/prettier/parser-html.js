(function (e) {
  ...
  var G = T((UD, Xr) => {
    ...
    Xr.exports =
      Be(typeof globalThis == "object" && globalThis) ||
      Be(typeof window == "object" && window) ||
      Be(typeof self == "object" && self) ||
      Be(typeof global == "object" && global) ||
      (function () {
        return this;
      })() ||
  ...
  var vt = T((sl, At) => {
    ...
    !Re &&
      ur &&
      ((te = ur.match(/Edge\/(\d+)/)), (!te || te[1] >= 74) && ((te = ur.match(/Chrome\/(\d+)/)), te && (Re = +te[1])));
    At.exports = Re;
  });
  var nr = T((al, St) => {
    var _t = vt(),
  ...
  var Ot = T((pl, Nt) => {
    ...
    Nt.exports = function (e, r) {
      var t, a;
      if (
        (r === "string" && or((t = e.toString)) && !cr((a = ir(t, e)))) ||
        (or((t = e.valueOf)) && !cr((a = ir(t, e)))) ||
        (r !== "string" && or((t = e.toString)) && !cr((a = ir(t, e))))
      )
        return a;
  ...
  var ke = T((fl, xt) => {
    ...
    xt.exports = function (e, r) {
      try {
        aa(Rt, e, { value: r, configurable: !0, writable: !0 });
      } catch {
        Rt[e] = r;
      }
      return r;
  ...
  var fr = T((Sl, tu) => {
    ...
    tu.exports =
      ...
      !ka(function () {
        return (
          Object.defineProperty(La("div"), "a", {
            get: function () {
              return 7;
            },
          }).a != 7
      ...
      ? ri
        ? function (r, t, a) {
            if (
              ...
              (t = cu(t)),
              je(a),
              typeof r == "function" && t === "prototype" && "value" in a && gr in a && !a[gr])
            ) {
              var D = ui(r, t);
              D &&
                D[gr] &&
                ((r[t] = a.value),
                (a = { configurable: mr in a ? a[mr] : D[mr], enumerable: Cr in a ? a[Cr] : D[Cr], writable: !1 }));
            }
            return dr(r, t, a);
          }
        : dr
    ...
    (qu.exports = function (e, r, t, a) {
      ...
      if (
        (wu(t) &&
          ...
          (!Bi(t, "name") || (Oi && t.name !== E)) && Nu(t, "name", E),
          (p = Ii(t)),
          p.source || (p.source = Ri.join(typeof E == "string" ? E : ""))),
        e === bi)
      ) {
        n ? (e[r] = t) : wi(r, t);
        return;
  ...
  var Uu = T(($l, $u) => {
    ...
    $u.exports = { includes: ju(!0), indexOf: ju(!1) };
  });
  var Xu = T((Ul, Vu) => {
    var Hi = Q(),
      Nr = ae(),
    ...
    Vu.exports = function (e, r) {
      var t = zi(e),
        ...
        D = [],
        n;
      for (n in t) !Nr(Yi, n) && Nr(t, n) && Gu(D, n);
      for (; r.length > a; ) Nr(t, (n = r[a++])) && (~Wi(D, n) || Gu(D, n));
      return D;
    };
  });
  var zu = T((Gl, Hu) => {
    ...
    sn.exports = function (e, r) {
      ...
      if ((a ? (c = Or) : D ? (c = Or[t] || go(t, {})) : (c = (Or[t] || {}).prototype), c))
        for (E in r) {
          if (
            ((g = r[E]),
            e.noTargetGet ? ((s = Eo(c, E)), (p = s && s.value)) : (p = c[E]),
            (n = Ao(a ? E : t + (D ? "." : "#") + E, e.forced)),
            !n && p !== void 0)
          ) {
  ...
  var fn = T((t2, hn) => {
    ...
    var Bo = G(),
      ...
      Oo = Ir(),
      qo = Bo.TypeError,
      pn = function (e, r, t, a, D, n, c, E) {
        for (var p = D, g = 0, s = c ? Oo(c, E) : !1, o, l; g < a; ) {
          if (g in t) {
            if (((o = s ? s(t[g], g, r) : t[g]), n > 0 && wo(o))) (l = No(o)), (p = pn(e, r, o, l, p, n - 1) - 1);
            else {
    ...
    mn.exports = Po
      ...
      : function (e) {
          ...
          return e === void 0
            ...
            : e === null
            ? "Null"
            : typeof (t = Uo((r = jo(e)), Mo)) == "string"
            ? t
            : $o
            ? ze(r)
            : (a = ze(r)) == "Object" && ko(r.callee)
            ? "Arguments"
            : a;
        };
  });
  ...
  var Bn = T((a2, bn) => {
    ...
    bn.exports = function (e) {
      ...
      return (
        yn(e) &&
          ((r = e.constructor),
          Jo(r) && (r === Tn || yn(r.prototype)) ? (r = void 0) : Zo(r) && ((r = r[rc]), r === null && (r = void 0))),
        r === void 0 ? Tn : r
      );
    };
  });
      ...
      { target: "Array", proto: !0 },
      {
        flatMap: function (r) {
          var t = ac(this),
            ...
            D;
          return (
            sc(r), (D = oc(t, 0)), (D.length = nc(D, t, t, a, 0, 1, r, arguments.length > 1 ? arguments[1] : void 0)), D
          );
        },
      }
    );
  ...
  var Hn = T((E2, Xn) => {
    ...
    Xn.exports = function (e, r, t) {
      ...
      if (n) p = e;
        ...
        if (Oc(g)) {
          for (s = 0, o = qc(e); o > s; s++) if (((l = b(e[s])), l && Un(Vn, l))) return l;
          return new We(!1);
        }
        p = Ic(e, g);
      }
    ...
    var is = Object.getOwnPropertyNames,
      ...
      zc = R({
        "node_modules/angular-html-parser/lib/compiler/src/util.js"(e) {
          ...
          (e.ValueTransformer = g),
            (e.SyncAsync = {
              assertSync: (i) => {
                if (A(i)) throw new Error("Illegal state: value cannot be a promise");
                return i;
              },
              then: (i, d) => (A(i) ? i.then(d) : d(i)),
              all: (i) => (i.some(A) ? Promise.all(i) : i),
            });
          function s(i) {
          ...
          function O(i) {
            ...
            for (let h = 0; h < i.length; h++) {
              ...
              _ <= 127
                ...
                : _ <= 2047
                ? (d += String.fromCharCode(((_ >> 6) & 31) | 192, (_ & 63) | 128))
                : _ <= 65535
                ? (d += String.fromCharCode((_ >> 12) | 224, ((_ >> 6) & 63) | 128, (_ & 63) | 128))
                : _ <= 2097151 &&
        ...
        "node_modules/angular-html-parser/lib/compiler/src/compile_metadata.js"(e) {
          ...
          var b = class {
            constructor(h) {
              ...
              if (
                ((this.encapsulation = _),
                (this.template = k),
                (this.templateUrl = $),
                (this.htmlAst = W),
                (this.styles = A(X)),
                (this.styleUrls = A(H)),
                (this.externalStylesheets = A(z)),
                (this.animations = J ? I(J) : []),
          ...
          var B = class {
            ...
            constructor(h) {
              ...
              (this.isHost = !!_),
                ...
                (this.selector = W),
                (this.exportAs = X),
                (this.changeDetection = H),
                (this.inputs = z),
                (this.outputs = J),
                (this.hostListeners = Z),
                (this.hostProperties = ee),
                (this.hostAttributes = S),
                (this.providers = A(y)),
                (this.viewProviders = A(N)),
                (this.queries = A(q)),
                (this.guards = M),
                (this.viewQueries = A(U)),
                (this.entryComponents = A(V)),
                (this.template = Y),
                (this.componentViewType = ue),
                (this.rendererType = Te),
                (this.componentFactory = be);
            }
            toSummary() {
              return {
          ...
          var F = class {
            constructor(h) {
              ...
              (this.type = _ || null),
                (this.declaredDirectives = A($)),
                (this.exportedDirectives = A(W)),
                (this.declaredPipes = A(X)),
                (this.exportedPipes = A(H)),
                (this.providers = A(k)),
                (this.entryComponents = A(z)),
                (this.bootstrapComponents = A(J)),
                (this.importedModules = A(Z)),
                (this.exportedModules = A(ee)),
                (this.schemas = A(S)),
                (this.id = N || null),
          ...
          var w = class {
            constructor(h, _) {
              ...
              (this.token = h),
                ...
                (this.useValue = $),
                (this.useExisting = W),
                (this.useFactory = X || null),
                (this.dependencies = H || null),
                (this.multi = !!z);
            }
          };
          e.ProviderMeta = w;
          ...
          function j(h, _, k) {
            ...
            return (
              k.isInline
                ? _.type.reference instanceof r.StaticSymbol
                  ? ($ = "".concat(_.type.reference.filePath, ".").concat(_.type.reference.name, ".html"))
                  : ($ = "".concat(c(h), "/").concat(c(_.type), ".html"))
                : ($ = k.templateUrl),
              _.type.reference instanceof r.StaticSymbol ? $ : L($)
            );
          }
          e.templateSourceUrl = j;
          function u(h, _) {
            let k = h.moduleUrl.split(/\/\\/g),
              $ = k[k.length - 1];
...
` && ++b == o
          ...
          var E = class {
            ...
            contextualMessage() {
              ...
              return s
                ? "".concat(this.msg, ' ("').concat(s.before, "[").concat(c[this.level], " ->]").concat(s.after, '")')
                : this.msg;
            }
            toString() {
          ...
          e.typeSourceSpan = p;
          function g(s, o, l) {
            let C = "in ".concat(s, " ").concat(o, " in ").concat(l),
              f = new D("", C);
            return new n(new a(f, -1, -1, -1), new a(f, -1, -1, -1));
          }
      ...
      Yc = R({
        "src/utils/front-matter/parse.js"(e, r) {
          ...
          function a(D) {
            ...
            let { startDelimiter: c, language: E, value: p = "", endDelimiter: g } = n.groups,
              s = E.trim() || "yaml";
            if ((c === "+++" && (s = "toml"), s !== "yaml" && c !== g)) return { content: D };
            let [o] = n;
            return {
              frontMatter: {
                type: "front-matter",
      ...
      Kc = R({
        "vendors/escape-string-regexp.js"(e, r) {
          ...
          var t = Object.defineProperty,
            ...
            c = (o, l) => {
              for (var C in l) t(o, C, { get: l[C], enumerable: !0 });
            },
            E = (o, l, C, f) => {
      ...
      cs = R({
        "node_modules/semver/internal/debug.js"(e, r) {
          P();
          var t =
            typeof Se == "object" && Se.env && Se.env.NODE_DEBUG && /\bsemver\b/i.test(Se.env.NODE_DEBUG)
              ? function () {
      ...
      Jc = R({
        "node_modules/semver/internal/re.js"(e, r) {
          P();
          var { MAX_SAFE_COMPONENT_LENGTH: t } = Ds(),
            a = cs();
          e = r.exports = {};
          var D = (e.re = []),
            n = (e.src = []),
          ...
          p("NUMERICIDENTIFIER", "0|[1-9]\\d*"),
            ...
            p("PRERELEASEIDENTIFIER", "(?:".concat(n[c.NUMERICIDENTIFIER], "|").concat(n[c.NONNUMERICIDENTIFIER], ")")),
            p(
            ...
            p(
              "PRERELEASELOOSE",
              "(?:-?(".concat(n[c.PRERELEASEIDENTIFIERLOOSE], "(?:\\.").concat(n[c.PRERELEASEIDENTIFIERLOOSE], ")*))")
            ),
      ...
      rD = R({
        "node_modules/semver/classes/semver.js"(e, r) {
          P();
          var t = cs(),
            { MAX_LENGTH: a, MAX_SAFE_INTEGER: D } = Ds(),
            { re: n, t: c } = Jc(),
            E = Zc(),
            { compareIdentifiers: p } = eD(),
            g = class {
              constructor(s, o) {
                ...
                l[4]
                  ? (this.prerelease = l[4].split(".").map((C) => {
                      if (/^[0-9]+$/.test(C)) {
                        let f = +C;
                        if (f >= 0 && f < D) return f;
                      }
      ...
      aD = R({
        "node_modules/outdent/lib/index.js"(e, r) {
          "use strict";
          P(), Object.defineProperty(e, "__esModule", { value: !0 }), (e.outdent = void 0);
          function t() {
          ...
          function f(v, O) {
            for (var F = "", x = 0, A = v.length; x < A; x++) (F += v[x]), x < A - 1 && (F += O[x]);
            return F;
          }
          function m(v) {
          ...
          var B = b({ trimLeadingNewline: !0, trimTrailingNewline: !0 });
          if (((e.outdent = B), (e.default = B), typeof r < "u"))
            try {
              (r.exports = B), Object.defineProperty(B, "__esModule", { value: !0 }), (B.default = B), (B.outdent = B);
            } catch {}
        },
      }),
      iD = R({
        ...
        "src/main/support.js"(e, r) {
          ...
          function c() {
            let {
              ...
              l = D.split("-", 1)[0],
              C = p.flatMap((v) => v.languages || []).filter(m),
              f = a(
                Object.assign(
                  {},
                  ...p.map((v) => {
                ...
                .filter((v) => m(v) && b(v))
                .sort((v, O) => (v.name === O.name ? 0 : v.name < O.name ? -1 : 1))
                .map(B)
                .map((v) => {
                  (v = Object.assign({}, v)),
                    Array.isArray(v.default) &&
                      (v.default =
                        v.default.length === 1
                          ? v.default[0].value
                          : v.default.filter(m).sort((F, x) => t.compare(x.since, F.since))[0].value),
                    Array.isArray(v.choices) &&
                      ((v.choices = v.choices.filter((F) => m(F) && b(F))), v.name === "parser" && E(v, C, p));
                  let O = Object.fromEntries(
                    p
                      .filter((F) => F.defaultOptions && F.defaultOptions[v.name] !== void 0)
                      .map((F) => [F.name, F.defaultOptions[v.name]])
                  );
            ...
            function B(v) {
              if (o) return v;
              let { cliName: O, cliCategory: F, cliDescription: x } = v;
              return Gc(v, Uc);
            }
          }
          function E(p, g, s) {
            ...
            for (let l of g)
              if (l.parsers) {
                for (let C of l.parsers)
                  if (!o.has(C)) {
                    o.add(C);
                    let f = s.find((b) => b.parsers && b.parsers[C]),
                      m = l.name;
                    f && f.name && (m += " (plugin: ".concat(f.name, ")")),
                      p.choices.push({ value: C, description: m });
                  }
              }
          }
      ...
      DD = R({
        "vendors/string-width.js"(e, r) {
          ...
          var t = Object.create,
            ...
            g = (F, x) => {
              for (var A in x) a(F, A, { get: x[A], enumerable: !0 });
            },
            s = (F, x, A, w) => {
            ...
            o = (F, x, A) => (
              (A = F != null ? t(c(F)) : {}),
              s(x || !F || !F.__esModule ? a(A, "default", { value: F, enumerable: !0 }) : A, F)
            ),
            l = (F) => s(a({}, "__esModule", { value: !0 }), F),
            C = p({
              "node_modules/emoji-regex/index.js"(F, x) {
                "use strict";
                x.exports = function () {
        ...
        "src/utils/text/skip-inline-comment.js"(e, r) {
          ...
          function t(a, D) {
            ...
            if (a.charAt(D) === "/" && a.charAt(D + 1) === "*") {
              for (let n = D + 2; n < a.length; ++n) if (a.charAt(n) === "*" && a.charAt(n + 1) === "/") return n + 2;
            }
            return D;
          }
          r.exports = t;
      ...
      pD = R({
        "src/utils/text/get-next-non-space-non-comment-character-index-with-start-index.js"(e, r) {
          ...
          function c(E, p) {
            let g = null,
              s = p;
            for (; s !== g; ) (g = s), (s = n(E, s)), (s = t(E, s)), (s = D(E, s)), (s = a(E, s));
            return s;
          }
          r.exports = c;
        },
      ...
      fs = R({
        "src/common/util.js"(e, r) {
          ...
          var { default: t } = Kc(),
            ...
            n = cD(),
            c = lD(),
            { skipWhitespace: E, skipSpaces: p, skipToLineEnd: g, skipEverythingButNewLine: s } = $r(),
            o = ls(),
            l = ps(),
            C = hs(),
            f = pD(),
...
`
          ...
          function O(S, y, N) {
            let q = N(y) - 1;
            (q = p(S, q, { backwards: !0 })), (q = C(S, q, { backwards: !0 })), (q = p(S, q, { backwards: !0 }));
            let M = C(S, q, { backwards: !0 });
            return q !== M;
          }
          function F(S, y) {
            let N = null,
              q = y;
            for (; q !== N; ) (N = q), (q = g(S, q)), (q = o(S, q)), (q = p(S, q));
          ...
          function L(S, y) {
            let N = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0,
              q = 0;
            for (let M = N; M < S.length; ++M) S[M] === "	" ? (q = q + y - (q % y)) : q++;
            return q;
          }
          function j(S, y) {
            let N = S.lastIndexOf(`
`);
          ...
          function u(S, y) {
            let N = { quote: '"', regex: /"/g, escaped: "&quot;" },
              q = { quote: "'", regex: /'/g, escaped: "&apos;" },
              M = y === "'" ? q : N,
              U = M === q ? N : q,
              V = M;
            if (S.includes(M.quote) || S.includes(U.quote)) {
              let Y = (S.match(M.regex) || []).length,
          ...
          function k(S, y) {
            ...
            for (let U = 1; U < M; U++) if (!q.get(U)) return U;
            return M + 1;
          }
          function $(S, y) {
          ...
          function z(S, y) {
            let { languages: N } = D({ plugins: y.plugins }),
              q =
                N.find((M) => {
                  let { name: U } = M;
          ...
          function ee(S) {
            let y = S.type || S.kind || "(unknown type)",
              N = String(
                S.name ||
      ...
      CD = R({
        "src/language-html/utils/html-elements-attributes.js"(e, r) {
          "use strict";
          P();
          var { htmlElementAttributes: t } = ED(),
            a = dD(),
            D = Es(),
            n = a(t, D);
          r.exports = n;
...
` + D.replace(/^\s*\n/, "")
      ...
      FD = R({
        "src/language-html/ast.js"(e, r) {
          "use strict";
          P();
          var { isNonEmptyArray: t } = fs(),
            a = Mr(),
            D = { attrs: !0, children: !0 },
            n = class {
              constructor() {
                let g = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
                for (let [s, o] of Object.entries(g)) s in D ? this._setNodes(s, o) : (this[s] = o);
              }
              _setNodes(g, s) {
                s !== this[g] &&
                  ((this[g] = E(s, this)),
                  g === "attrs" && p(this, "attrMap", Object.fromEntries(this[g].map((o) => [o.fullName, o.value]))));
              }
              map(g) {
                let s = null;
                for (let o in D) {
              ...
              walk(g) {
                for (let s in D) {
                  let o = this[s];
                  if (o) for (let l = 0; l < o.length; l++) o[l].walk(g);
                }
                g(this);
              }
          ...
          function p(g, s, o) {
            Object.defineProperty(g, s, { value: o, enumerable: !1 });
          }
          r.exports = { Node: n };
        },
      }),
...
`,
      ...
      Cs = R({
        "node_modules/angular-html-parser/lib/compiler/src/ml_parser/ast.js"(e) {
          ...
          var n = class {
            constructor(f, m, b, B, v) {
              (this.value = f),
                (this.expression = m),
                (this.sourceSpan = b),
                (this.valueSourceSpan = B),
                (this.expSourceSpan = v);
            }
            visit(f, m) {
          ...
          var c = class {
            constructor(f, m, b) {
              let B = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : null,
          ...
          var E = class {
            constructor(f, m, b, B) {
              let v = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : null,
                O = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : null,
          ...
          function s(f, m) {
            let b = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null,
              B = [],
              v = f.visit ? (O) => f.visit(O, b) || O.visit(f, b) : (O) => O.visit(f, b);
            return (
              m.forEach((O) => {
                let F = v(O);
                F && B.push(F);
          ...
          function l(f) {
            let m = f.sourceSpan.start.offset,
          ...
          function C(f, m) {
            let b = [],
              B = new (class extends o {
                visit(v, O) {
                  let F = l(v);
                  if (F.start <= m && m < F.end) b.push(v);
                  else return !0;
                }
              })();
              ...
              constructor(u, i, d) {
                (this._getTagContentType = i),
                  ...
                  (this._leadingTriviaCodePoints =
                    d.leadingTriviaChars && d.leadingTriviaChars.map((_) => _.codePointAt(0) || 0)),
...
`
              ...
              _attemptStr(u) {
                ...
                for (let h = 0; h < i; h++) if (!this._attemptCharCode(u.charCodeAt(h))) return (this._cursor = d), !1;
                return !0;
              }
              ...
              _consumePrefixAndName() {
                let u = this._cursor.clone(),
                  i = "";
                for (; this._cursor.peek() !== r.$COLON && !B(this._cursor.peek()); ) this._cursor.advance();
                let d;
              ...
              _consumeTagOpen(u) {
                ...
                try {
                  ...
                  for (
                    h = this._consumeTagOpenStart(u), d = h.parts[0], i = h.parts[1], this._attemptCharCodeUntilFn(m);
                ...
                this._handleFullNameStackForTagOpen(d, i),
                  W === D.TagContentType.RAW_TEXT
                    ? this._consumeRawTextWithTagClose(d, i, !1)
                    : W === D.TagContentType.ESCAPABLE_RAW_TEXT && this._consumeRawTextWithTagClose(d, i, !0);
              }
              _consumeRawTextWithTagClose(u, i, d) {
                let h = this._consumeRawText(d, () =>
                  ...
                  !this._attemptStrCaseInsensitive(u ? "".concat(u, ":").concat(i) : i))
                    ? !1
                    : (this._attemptCharCodeUntilFn(m), this._attemptCharCode(r.$GT))
                );
                this._beginToken(n.TAG_CLOSE),
                  this._requireCharCodeUntilFn((_) => _ === r.$GT, 3),
                  this._cursor.advance(),
                  this._endToken([u, i]),
              ...
              _isTextEnd() {
                return !!(
                  ...
                  (this._tokenizeIcu &&
                    !this._inInterpolation &&
                    (this.isExpansionFormStart() || (this._cursor.peek() === r.$RBRACE && this._isInExpansionCase())))
                );
              }
              _readUntil(u) {
                let i = this._cursor.clone();
              ...
              _handleFullNameStackForTagOpen(u, i) {
                ...
                (this._fullNameStack.length === 0 || this._fullNameStack[this._fullNameStack.length - 1] === d) &&
          ...
          function w(u) {
            ...
            for (let h = 0; h < u.length; h++) {
              let _ = u[h];
              d && d.type == n.TEXT && _.type == n.TEXT
                ? ((d.parts[0] += _.parts[0]), (d.sourceSpan.end = _.sourceSpan.end))
                : ((d = _), i.push(d));
            }
            return i;
          }
          ...
          var p = class {
            ...
            _parseExpansionCase() {
              ...
              if (this._peek.type !== a.TokenType.EXPANSION_CASE_EXP_START)
                return (
                  this._errors.push(n.create(null, this._peek.sourceSpan, "Invalid ICU message. Missing '{'.")), null
                );
              let o = this._advance(),
              ...
              let m = new r.ParseSourceSpan(s.sourceSpan.start, C.sourceSpan.end),
            ...
            _collectExpansionExpTokens(s) {
              ...
              for (;;) {
                ...
                if (this._peek.type === a.TokenType.EXPANSION_FORM_END)
                  if (g(l, a.TokenType.EXPANSION_FORM_START)) l.pop();
                  else
                    return this._errors.push(n.create(null, s.sourceSpan, "Invalid ICU message. Missing '}'.")), null;
...
`
            ...
            _consumeStartTag(s) {
              let o = s.parts[0],
                l = s.parts[1],
                C = [];
              for (; this._peek.type === a.TokenType.ATTR_NAME; ) C.push(this._consumeAttr(this._advance()));
            ...
            _consumeAttr(s) {
              let o = D.mergeNsAndName(s.parts[0], s.parts[1]),
                ...
                m;
              if (
                (this._peek.type === a.TokenType.ATTR_QUOTE && (m = this._advance().sourceSpan.start),
              ...
              return (
                this._peek.type === a.TokenType.ATTR_QUOTE &&
                  ((l = this._advance().sourceSpan.end), (f = new r.ParseSourceSpan(m, l))),
                new t.Attribute(o, C, new r.ParseSourceSpan(s.sourceSpan.start, l), f, s.sourceSpan)
              );
            }
            _getParentElement() {
        ...
        "node_modules/angular-html-parser/lib/angular-html-parser/src/index.js"(e) {
          ...
          function n(c) {
            let E = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {},
              {
                canSelfClose: p = !1,
                allowHtmComponentClosingTags: g = !1,
    ...
    P();
    var { ParseSourceSpan: Ye, ParseLocation: ss, ParseSourceFile: BD } = ye(),
      wD = Yc(),
      ND = Mr(),
      OD = Qc(),
      { inferParserByLanguage: qD } = fs(),
      ID = fD(),
      Lr = CD(),
      as = mD(),
      { hasPragma: RD } = gD(),
      { Node: xD } = FD(),
      { parseIeConditionalComment: PD } = AD(),
      { locStart: kD, locEnd: LD } = vD();
    function MD(e, r, t) {
      let {
          recognizeSelfClosing: a,
          normalizeTagName: D,
        ...
        g = ms(),
        { RecursiveVisitor: s, visitAll: o } = Cs(),
        { ParseSourceSpan: l } = ye(),
        { getHtmlTagDefinition: C } = ds(),
        { rootNodes: f, errors: m } = g.parse(e, {
          canSelfClose: a,
          allowHtmComponentClosingTags: c,
          isTagNameCaseSensitive: E,
          getTagContentType: p,
      ...
      if (t.parser === "vue")
        if (
          f.some(
            (w) =>
              (w.type === "docType" && w.value === "html") || (w.type === "element" && w.name.toLowerCase() === "html")
          )
        ) {
          (a = !0), (D = !0), (n = !0), (c = !0), (E = !1);
          ...
          let w = (I) => {
            ...
            let L = I.attrs.find((u) => u.name === "lang"),
              j = L && L.value;
            return !j || qD(j, t) === "html";
          };
          if (f.some(w)) {
            let I,
              L = () => g.parse(e, { canSelfClose: a, allowHtmComponentClosingTags: c, isTagNameCaseSensitive: E }),
              j = () => I || (I = L()),
              u = (i) =>
                j().rootNodes.find((d) => {
            ...
            for (let i = 0; i < f.length; i++) {
              let d = f[i],
                { endSourceSpan: h, startSourceSpan: _ } = d;
              if (h === null) (m = j().errors), (f[i] = u(d) || d);
              else if (w(d)) {
                let $ = j(),
                  W = _.end.offset,
                  X = h.start.offset;
      ...
      let b = (A) => {
          let w = A.name.startsWith(":") ? A.name.slice(1).split(":")[0] : null,
          ...
          switch (A.type) {
            case "element":
              ...
              for (let w of A.attrs)
                b(w),
                  w.valueSpan
                    ? ((w.value = w.valueSpan.toString()), /["']/.test(w.value[0]) && (w.value = w.value.slice(1, -1)))
                    : (w.value = null);
              break;
            case "comment":
        ...
        O = (A) => {
          if (
            A.type === "element" &&
            (D &&
              (!A.namespace || A.namespace === A.tagDefinition.implicitNamespacePrefix || as(A)) &&
              (A.name = v(A.name, (w) => w in ID)),
            n)
          ) {
            let w = Lr[A.name] || Object.create(null);
            for (let I of A.attrs) I.namespace || (I.name = v(I.name, (L) => A.name in Lr && (L in Lr["*"] || L in w)));
          }
        },
        F = (A) => {
        ...
        x = (A) => {
          if (A.type === "element") {
            ...
            !A.namespace || A.namespace === w.implicitNamespacePrefix || as(A)
              ? (A.tagDefinition = w)
              : (A.tagDefinition = C(""));
          }
        };
    ...
    function gs(e, r, t) {
      let a = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !0,
        { frontMatter: D, content: n } = a ? wD(e) : { frontMatter: null, content: e },
        c = new BD(e, r.filepath),
        E = new ss(c, 0, 0, 0),
        p = E.moveBy(e.length),
        g = { type: "root", sourceSpan: new Ye(E, p), children: MD(n, t, r) };
      if (D) {
        let l = new ss(c, 0, 0, 0),
      ...
      let s = new xD(g),
        o = (l, C) => {
          ...
          return (
            v.length === f
              ? B.children.shift()
              : ((v.sourceSpan = new Ye(v.sourceSpan.start.moveBy(f), v.sourceSpan.end)), (v.value = v.value.slice(f))),
            B
          );
        };
      return (
    ...
    function Qe() {
      let {
        name: e,
        recognizeSelfClosing: r = !1,
        normalizeTagName: t = !1,
        normalizeAttributeName: a = !1,
        allowHtmComponentClosingTags: D = !1,
        isTagNameCaseSensitive: n = !1,
        getTagContentType: c,
      } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      return {
        parse: (E, p, g) =>
          gs(E, Object.assign({ parser: e }, g), {
    ...
    Fs.exports = {
      parsers: {
        ...
        angular: Qe({ name: "angular" }),
        vue: Qe({
          name: "vue",
          recognizeSelfClosing: !0,
          isTagNameCaseSensitive: !0,
          getTagContentType: (e, r, t, a) => {
            if (
              e.toLowerCase() !== "html" &&
              !t &&
              (e !== "template" ||
