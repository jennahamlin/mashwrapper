(function (e) {
  ...
  var be = oe((Ce, ae) => {
    var H = Object.getOwnPropertyNames,
      ...
      K = se({ "<define:process>"() {} }),
      ce = L({
        "src/common/parser-create-error.js"(a, d) {
          "use strict";
          K();
          function i(c, r) {
      ...
      ue = L({
        "src/utils/try-combinations.js"(a, d) {
          "use strict";
          K();
          function i() {
            let c;
      ...
      le = L({
        "src/language-graphql/pragma.js"(a, d) {
          "use strict";
          K();
          function i(r) {
            return /^\s*#[^\S\n]*@(?:format|prettier)\s*(?:\n|$)/.test(r);
...
` + r
      ...
      pe = L({
        "src/language-graphql/loc.js"(a, d) {
          "use strict";
          K();
          function i(r) {
      ...
      fe = L({
        "node_modules/graphql/jsutils/isObjectLike.js"(a) {
          "use strict";
          K(), Object.defineProperty(a, "__esModule", { value: !0 }), (a.default = i);
          function d(c) {
            return (
      ...
      z = L({
        "node_modules/graphql/polyfills/symbols.js"(a) {
          "use strict";
          K(),
            Object.defineProperty(a, "__esModule", { value: !0 }),
            (a.SYMBOL_TO_STRING_TAG = a.SYMBOL_ASYNC_ITERATOR = a.SYMBOL_ITERATOR = void 0);
      ...
      $ = L({
        "node_modules/graphql/language/location.js"(a) {
          "use strict";
          K(), Object.defineProperty(a, "__esModule", { value: !0 }), (a.getLocation = d);
          function d(i, c) {
      ...
      de = L({
        "node_modules/graphql/language/printLocation.js"(a) {
          "use strict";
          K(),
            Object.defineProperty(a, "__esModule", { value: !0 }),
            (a.printLocation = i),
            (a.printSourceLocation = c);
          var d = $();
          function i(k) {
            return c(k.source, (0, d.getLocation)(k.source, k.start));
          }
          function c(k, O) {
            var A = k.locationOffset.column - 1,
              N = _(A) + k.body,
              g = O.line - 1,
...
`);
      ...
      W = L({
        "node_modules/graphql/error/GraphQLError.js"(a) {
          "use strict";
          K();
          function d(f) {
            return (
          ...
          Object.defineProperty(a, "__esModule", { value: !0 }), (a.printError = y), (a.GraphQLError = void 0);
          var i = E(fe()),
            c = z(),
            r = $(),
            _ = de();
          ...
          var u = (function (f) {
            ...
            function o(h, l, T, S, x, b, M) {
              ...
              var R = Array.isArray(l) ? (l.length !== 0 ? l : void 0) : l ? [l] : void 0,
                Y = T;
              if (!Y && R) {
                var J;
              ...
              return (
                Object.defineProperties(v(C), {
                  ...
                  message: { value: h, enumerable: !0, writable: !0 },
                  ...
                  source: { value: (V = Y) !== null && V !== void 0 ? V : void 0 },
                  positions: { value: (q = F) !== null && q !== void 0 ? q : void 0 },
                  originalError: { value: b },
                  extensions: { value: (G = j) !== null && G !== void 0 ? G : void 0, enumerable: j != null },
                }),
                b != null && b.stack
                  ? (Object.defineProperty(v(C), "stack", { value: b.stack, writable: !0, configurable: !0 }), D(C))
                  : (Error.captureStackTrace
                      ? Error.captureStackTrace(v(C), o)
                      : Object.defineProperty(v(C), "stack", { value: Error().stack, writable: !0, configurable: !0 }),
                    C)
              );
            }
            return (
...
` + (0, _.printSourceLocation)(f.source, x);
      ...
      Z = L({
        "node_modules/graphql/error/syntaxError.js"(a) {
          "use strict";
          K(), Object.defineProperty(a, "__esModule", { value: !0 }), (a.syntaxError = i);
          var d = W();
          function i(c, r, _) {
      ...
      he = L({
        "node_modules/graphql/language/kinds.js"(a) {
          "use strict";
          K(), Object.defineProperty(a, "__esModule", { value: !0 }), (a.Kind = void 0);
          var d = Object.freeze({
            NAME: "Name",
            DOCUMENT: "Document",
      ...
      ve = L({
        "node_modules/graphql/jsutils/invariant.js"(a) {
          "use strict";
          K(), Object.defineProperty(a, "__esModule", { value: !0 }), (a.default = d);
          function d(i, c) {
            var r = Boolean(i);
            if (!r) throw new Error(c != null ? c : "Unexpected invariant triggered.");
          }
        },
      }),
      ee = L({
        "node_modules/graphql/jsutils/nodejsCustomInspectSymbol.js"(a) {
          "use strict";
      ...
      Te = L({
        "node_modules/graphql/jsutils/defineInspect.js"(a) {
          "use strict";
          K(), Object.defineProperty(a, "__esModule", { value: !0 }), (a.default = r);
          var d = c(ve()),
            i = c(ee());
          function c(_) {
          ...
          function r(_) {
            ...
            typeof E == "function" || (0, d.default)(0),
              (_.prototype.inspect = E),
              i.default && (_.prototype[i.default] = E);
          }
        },
      }),
      te = L({
        "node_modules/graphql/language/ast.js"(a) {
          "use strict";
          K(), Object.defineProperty(a, "__esModule", { value: !0 }), (a.isNode = _), (a.Token = a.Location = void 0);
          var d = i(Te());
          function i(E) {
      ...
      ne = L({
        "node_modules/graphql/language/tokenKind.js"(a) {
          "use strict";
          K(), Object.defineProperty(a, "__esModule", { value: !0 }), (a.TokenKind = void 0);
          var d = Object.freeze({
            SOF: "<SOF>",
            EOF: "<EOF>",
            BANG: "!",
      ...
      re = L({
        "node_modules/graphql/jsutils/inspect.js"(a) {
          "use strict";
          K(), Object.defineProperty(a, "__esModule", { value: !0 }), (a.default = E);
          var d = i(ee());
          function i(v) {
          ...
          function O(v, I) {
            if (I.indexOf(v) !== -1) return "[Circular]";
            var s = [].concat(I, [v]),
              p = g(v);
            if (p !== void 0) {
              var e = p.call(v);
              if (e !== v) return typeof e == "string" ? e : k(e, s);
            } else if (Array.isArray(v)) return N(v, s);
            return A(v, s);
          }
          function A(v, I) {
            var s = Object.keys(v);
            if (s.length === 0) return "{}";
            if (I.length > _) return "[" + D(v) + "]";
          ...
          function N(v, I) {
            ...
            if (I.length > _) return "[Array]";
            for (var s = Math.min(r, v.length), p = v.length - s, e = [], n = 0; n < s; ++n) e.push(k(v[n], I));
            return (
              p === 1 ? e.push("... 1 more item") : p > 1 && e.push("... ".concat(p, " more items")),
              "[" + e.join(", ") + "]"
            );
          }
          function g(v) {
      ...
      _e = L({
        "node_modules/graphql/jsutils/devAssert.js"(a) {
          "use strict";
          K(), Object.defineProperty(a, "__esModule", { value: !0 }), (a.default = d);
          function d(i, c) {
            var r = Boolean(i);
            if (!r) throw new Error(c);
          }
        },
      }),
      Ee = L({
        "node_modules/graphql/jsutils/instanceOf.js"(a) {
          "use strict";
          K(), Object.defineProperty(a, "__esModule", { value: !0 }), (a.default = void 0);
          var d = i(re());
          function i(r) {
      ...
      me = L({
        "node_modules/graphql/language/source.js"(a) {
          "use strict";
          K(), Object.defineProperty(a, "__esModule", { value: !0 }), (a.isSource = A), (a.Source = void 0);
          var d = z(),
            i = _(re()),
            c = _(_e()),
            r = _(Ee());
          ...
          var O = (function () {
            function N(g) {
              var D = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "GraphQL request",
                v = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : { line: 1, column: 1 };
              typeof g == "string" ||
                (0, c.default)(0, "Body must be a string. Received: ".concat((0, i.default)(g), ".")),
                (this.body = g),
                (this.name = D),
                (this.locationOffset = v),
                this.locationOffset.line > 0 ||
                  (0, c.default)(0, "line in locationOffset is 1-indexed and must be positive."),
                this.locationOffset.column > 0 ||
                  (0, c.default)(0, "column in locationOffset is 1-indexed and must be positive.");
            }
            return (
              k(N, [
                {
                  key: d.SYMBOL_TO_STRING_TAG,
                  get: function () {
                    return "Source";
                  },
                },
      ...
      ye = L({
        "node_modules/graphql/language/directiveLocation.js"(a) {
          "use strict";
          K(), Object.defineProperty(a, "__esModule", { value: !0 }), (a.DirectiveLocation = void 0);
          var d = Object.freeze({
            QUERY: "QUERY",
            MUTATION: "MUTATION",
      ...
      ke = L({
        "node_modules/graphql/language/blockString.js"(a) {
          "use strict";
          K(),
            Object.defineProperty(a, "__esModule", { value: !0 }),
            (a.dedentBlockStringValue = d),
            (a.getBlockStringIndentation = c),
            (a.printBlockString = r);
          function d(_) {
            var E = _.split(/\r\n|[\n\r]/g),
              k = c(_);
            if (k !== 0) for (var O = 1; O < E.length; O++) E[O] = E[O].slice(k);
            for (var A = 0; A < E.length && i(E[A]); ) ++A;
            for (var N = E.length; N > A && i(E[N - 1]); ) --N;
...
`);
          ...
          function c(_) {
            for (var E, k = !0, O = !0, A = 0, N = null, g = 0; g < _.length; ++g)
...
`),
      ...
      Ne = L({
        "node_modules/graphql/language/lexer.js"(a) {
          "use strict";
          ...
          function E(t) {
            return (
              t === c.TokenKind.BANG ||
              t === c.TokenKind.DOLLAR ||
              t === c.TokenKind.AMP ||
              t === c.TokenKind.PAREN_L ||
              t === c.TokenKind.PAREN_R ||
              t === c.TokenKind.SPREAD ||
              t === c.TokenKind.COLON ||
              t === c.TokenKind.EQUALS ||
              t === c.TokenKind.AT ||
              t === c.TokenKind.BRACKET_L ||
              t === c.TokenKind.BRACKET_R ||
              t === c.TokenKind.BRACE_L ||
              t === c.TokenKind.PIPE ||
              t === c.TokenKind.BRACE_R
            );
          }
          function k(t) {
            return isNaN(t)
          ...
          function g(t, u, y, f, m, o) {
            ...
            } else (T = D(t, T, l)), (l = h.charCodeAt(T));
            if (
              (l === 46 && ((S = !0), (l = h.charCodeAt(++T)), (T = D(t, T, l)), (l = h.charCodeAt(T))),
              (l === 69 || l === 101) &&
                ((S = !0),
                (l = h.charCodeAt(++T)),
                (l === 43 || l === 45) && (l = h.charCodeAt(++T)),
                (T = D(t, T, l)),
                (l = h.charCodeAt(T))),
              l === 46 || n(l))
            )
          ...
          function v(t, u, y, f, m) {
            for (
              var o = t.body, h = u + 1, l = h, T = 0, S = "";
              h < o.length && !isNaN((T = o.charCodeAt(h))) && T !== 10 && T !== 13;

            ) {
              if (T === 34) return (S += o.slice(l, h)), new i.Token(c.TokenKind.STRING, u, h + 1, y, f, m, S);
              if (T < 32 && T !== 9)
...
`;
                  ...
                  default:
                    throw (0, d.syntaxError)(
                      t,
                      h,
                      "Invalid character escape sequence: \\".concat(String.fromCharCode(T), ".")
                    );
                }
                ++h, (l = h);
              }
          ...
          function I(t, u, y, f, m, o) {
            for (var h = t.body, l = u + 3, T = l, S = 0, x = ""; l < h.length && !isNaN((S = h.charCodeAt(l))); ) {
              if (S === 34 && h.charCodeAt(l + 1) === 34 && h.charCodeAt(l + 2) === 34)
                return (
                  (x += h.slice(T, l)),
                  new i.Token(c.TokenKind.BLOCK_STRING, u, l + 3, y, f, m, (0, r.dedentBlockStringValue)(x))
                );
              if (S < 32 && S !== 9 && S !== 10 && S !== 13)
                throw (0, d.syntaxError)(t, l, "Invalid character within String: ".concat(k(S), "."));
              S === 10
                ? (++l, ++o.line, (o.lineStart = l))
                : S === 13
                ? (h.charCodeAt(l + 1) === 10 ? (l += 2) : ++l, ++o.line, (o.lineStart = l))
                : S === 92 && h.charCodeAt(l + 1) === 34 && h.charCodeAt(l + 2) === 34 && h.charCodeAt(l + 3) === 34
                ? ((x += h.slice(T, l) + '"""'), (l += 4), (T = l))
                : ++l;
            }
          ...
          function e(t, u, y, f, m) {
            for (
              var o = t.body, h = o.length, l = u + 1, T = 0;
              l !== h &&
              !isNaN((T = o.charCodeAt(l))) &&
              (T === 95 || (T >= 48 && T <= 57) || (T >= 65 && T <= 90) || (T >= 97 && T <= 122));
      ...
      Oe = L({
        "node_modules/graphql/language/parser.js"(a) {
          "use strict";
          K(),
            Object.defineProperty(a, "__esModule", { value: !0 }),
            (a.parse = O),
            ...
            return (
              ...
              (s.parseVariableDefinition = function () {
                ...
                return {
                  ...
                  defaultValue: this.expectOptionalToken(r.TokenKind.EQUALS) ? this.parseValueLiteral(!0) : void 0,
              ...
              (s.parseVariable = function () {
                ...
                return (
                  ...
                  { kind: i.Kind.VARIABLE, name: this.parseName(), loc: this.loc(e) }
                );
              }),
              ...
              (s.parseField = function () {
                var e = this._lexer.token,
                  ...
                  u;
                return (
                  this.expectOptionalToken(r.TokenKind.COLON) ? ((t = n), (u = this.parseName())) : (u = n),
                  {
                    kind: i.Kind.FIELD,
                    alias: t,
                    name: u,
              ...
              (s.parseArgument = function () {
                ...
                return (
                  ...
                  { kind: i.Kind.ARGUMENT, name: n, value: this.parseValueLiteral(!1), loc: this.loc(e) }
                );
              }),
              ...
              (s.parseFragmentDefinition = function () {
                ...
                return (
                  ...
                  ((e = this._options) === null || e === void 0 ? void 0 : e.experimentalFragmentVariables) === !0
                    ? {
                ...
                switch (n.kind) {
                  ...
                  case r.TokenKind.NAME:
                    switch ((this._lexer.advance(), n.value)) {
                      case "true":
                        return { kind: i.Kind.BOOLEAN, value: !0, loc: this.loc(n) };
                      case "false":
                        return { kind: i.Kind.BOOLEAN, value: !1, loc: this.loc(n) };
                      case "null":
              ...
              (s.parseStringLiteral = function () {
                ...
                return (
                  this._lexer.advance(),
                  { kind: i.Kind.STRING, value: e.value, block: e.kind === r.TokenKind.BLOCK_STRING, loc: this.loc(e) }
                );
              }),
              (s.parseList = function (e) {
                ...
                return {
                  kind: i.Kind.LIST,
                  values: this.any(r.TokenKind.BRACKET_L, u, r.TokenKind.BRACKET_R),
                  loc: this.loc(t),
                };
              }),
              (s.parseObject = function (e) {
                ...
                return {
                  kind: i.Kind.OBJECT,
                  fields: this.any(r.TokenKind.BRACE_L, u, r.TokenKind.BRACE_R),
                  loc: this.loc(t),
                };
              }),
              (s.parseObjectField = function (e) {
                ...
                return (
                  this.expectToken(r.TokenKind.COLON),
                  { kind: i.Kind.OBJECT_FIELD, name: t, value: this.parseValueLiteral(e), loc: this.loc(n) }
                );
              }),
                ...
                return (
                  this.expectOptionalToken(r.TokenKind.BRACKET_L)
                    ? ((n = this.parseTypeReference()),
                      ...
                      (n = { kind: i.Kind.LIST_TYPE, type: n, loc: this.loc(e) }))
                    : (n = this.parseNamedType()),
                  this.expectOptionalToken(r.TokenKind.BANG)
                    ? { kind: i.Kind.NON_NULL_TYPE, type: n, loc: this.loc(e) }
                    : n
                );
              }),
              ...
              (s.parseSchemaDefinition = function () {
                ...
                var t = this.parseDirectives(!0),
                  u = this.many(r.TokenKind.BRACE_L, this.parseOperationTypeDefinition, r.TokenKind.BRACE_R);
                return {
              ...
              (s.parseImplementsInterfaces = function () {
                ...
                if (
                  ((e = this._options) === null || e === void 0 ? void 0 : e.allowLegacySDLImplementsInterfaces) === !0
                ) {
                  var n = [];
              ...
              (s.parseFieldsDefinition = function () {
                var e;
                return ((e = this._options) === null || e === void 0 ? void 0 : e.allowLegacySDLEmptyFields) === !0 &&
              ...
              (s.parseSchemaExtension = function () {
                ...
                var n = this.parseDirectives(!0),
                  t = this.optionalMany(r.TokenKind.BRACE_L, this.parseOperationTypeDefinition, r.TokenKind.BRACE_R);
              ...
              (s.parseObjectTypeExtension = function () {
                ...
                if (t.length === 0 && u.length === 0 && y.length === 0) throw this.unexpected();
                return {
              ...
              (s.parseUnionTypeExtension = function () {
                ...
                if (t.length === 0 && u.length === 0) throw this.unexpected();
              ...
              (s.expectToken = function (e) {
                ...
                throw (0, d.syntaxError)(
                  this._lexer.source,
                  n.start,
                  "Expected ".concat(v(e), ", found ").concat(D(n), ".")
                );
              }),
              ...
              (s.expectKeyword = function (e) {
                ...
                if (n.kind === r.TokenKind.NAME && n.value === e) this._lexer.advance();
                  ...
                  throw (0, d.syntaxError)(
                    this._lexer.source,
                    n.start,
                    'Expected "'.concat(e, '", found ').concat(D(n), ".")
                  );
              }),
              ...
              (s.any = function (e, n, t) {
                this.expectToken(e);
                for (var u = []; !this.expectOptionalToken(t); ) u.push(n.call(this));
                return u;
              }),
              (s.optionalMany = function (e, n, t) {
                if (this.expectOptionalToken(e)) {
                  var u = [];
                  do u.push(n.call(this));
    ...
    function ie(a) {
      if (a && typeof a == "object") {
        ...
        for (let d in a) ie(a[d]);
      }
      return a;
    }
    var X = { allowLegacySDLImplementsInterfaces: !1, experimentalFragmentVariables: !0 };
    function Le(a) {
    ...
    function xe(a) {
      let { parse: d } = Oe(),
        { result: i, error: c } = ge(
          () => d(a, Object.assign({}, X)),
          () => d(a, Object.assign(Object.assign({}, X), {}, { allowLegacySDLImplementsInterfaces: !0 }))
        );
      if (!i) throw Le(c);
